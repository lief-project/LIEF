...
std::string& Symbol::name() { return name_; }

void Symbol::name(const std::string& name) { name_ = name; }

uint64_t Symbol::value() const { return value_; }

void Symbol::value(uint64_t value) { value_ = value; }

uint64_t Symbol::size() const { return size_; }

void Symbol::size(uint64_t value) { size_ = value; }
