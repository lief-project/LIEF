...
const char* to_string(EXE_FORMATS e) {
  CONST_MAP(EXE_FORMATS, const char*, 4)
  enumStrings{
...
const char* to_string(OBJECT_TYPES e) {
  CONST_MAP(OBJECT_TYPES, const char*, 4)
  enumStrings{
...
const char* to_string(ARCHITECTURES e) {
  CONST_MAP(ARCHITECTURES, const char*, 11)
  enumStrings{
...
const char* to_string(ENDIANNESS e) {
  CONST_MAP(ENDIANNESS, const char*, 3)
  enumStrings{
...
const char* to_string(Binary::VA_TYPES e) {
  CONST_MAP(Binary::VA_TYPES, const char*, 3)
  enumStrings{
...
const char* to_string(Function::FLAGS e) {
  CONST_MAP(Function::FLAGS, const char*, 5)
  enumStrings{
