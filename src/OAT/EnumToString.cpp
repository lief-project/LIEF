...
const char* to_string(OAT_CLASS_TYPES e) {
  CONST_MAP(OAT_CLASS_TYPES, const char*, 3)
  enumStrings{
...
const char* to_string(OAT_CLASS_STATUS e) {
  CONST_MAP(OAT_CLASS_STATUS, const char*, 13)
  enumStrings{
      ...
      {OAT_CLASS_STATUS::STATUS_RETRY_VERIFICATION_AT_RUNTIME,
...
const char* to_string(HEADER_KEYS e) {
  CONST_MAP(HEADER_KEYS, const char*, 11)
  enumStrings{
...
const char* to_string(INSTRUCTION_SETS e) {
  CONST_MAP(INSTRUCTION_SETS, const char*, 8)
  enumStrings{
