...
ChainedBindingInfo&
    ChainedBindingInfo::operator=(ChainedBindingInfo&&) noexcept = default;
...
ChainedBindingInfo::ChainedBindingInfo(const ChainedBindingInfo& other) :
  ...
  switch (btypes_) {
    case BIND_TYPES::ARM64E_AUTH_BIND:
      arm64_auth_bind_ =
          new details::dyld_chained_ptr_arm64e_auth_bind{*other.arm64_auth_bind_};
      break;
    ...
    case BIND_TYPES::ARM64E_BIND24:
      arm64_bind24_ =
          new details::dyld_chained_ptr_arm64e_bind24{*other.arm64_bind24_};
      break;
    case BIND_TYPES::ARM64E_AUTH_BIND24:
      arm64_auth_bind24_ = new details::dyld_chained_ptr_arm64e_auth_bind24{
          *other.arm64_auth_bind24_
      };
      break;
