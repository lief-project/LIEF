...
int32_t get_reloc_size(RELOC_x86_64 R) {
  CONST_MAP(RELOC_x86_64, uint32_t, 43) SIZES {
...
int32_t get_reloc_size(RELOC_i386 R) {
  CONST_MAP(RELOC_i386, uint32_t, 40) SIZES {
...
int32_t get_reloc_size(RELOC_ARM R) {
  ...
  CONST_MAP(RELOC_ARM, uint32_t, 138) SIZES {
...
int32_t get_reloc_size(RELOC_AARCH64 R) {
  CONST_MAP(RELOC_AARCH64, uint32_t, 123) SIZES {
...
int32_t get_reloc_size(RELOC_POWERPC32 R) {
  CONST_MAP(RELOC_POWERPC32, uint32_t, 57) SIZES {
...
int32_t get_reloc_size(RELOC_POWERPC64 R) {
  CONST_MAP(RELOC_POWERPC64, uint32_t, 84) SIZES {
...
int32_t get_reloc_size(RELOC_MIPS R) {
  CONST_MAP(RELOC_MIPS, uint32_t, 112) SIZES {
...
int32_t get_reloc_size(RELOC_LOONGARCH R) {
  CONST_MAP(RELOC_LOONGARCH, uint32_t, 89) SIZES {
    {RELOC_LOONGARCH::R_LARCH_NONE,                    0},
    {RELOC_LOONGARCH::R_LARCH_32,                     32},
    {RELOC_LOONGARCH::R_LARCH_64,                     64},
    {RELOC_LOONGARCH::R_LARCH_RELATIVE,               32},
    {RELOC_LOONGARCH::R_LARCH_COPY,                    0},
    {RELOC_LOONGARCH::R_LARCH_JUMP_SLOT,              64},
    {RELOC_LOONGARCH::R_LARCH_TLS_DTPMOD32,           32},
    {RELOC_LOONGARCH::R_LARCH_TLS_DTPMOD64,           64},
    {RELOC_LOONGARCH::R_LARCH_TLS_DTPREL32,           32},
    {RELOC_LOONGARCH::R_LARCH_TLS_DTPREL64,           64},
    {RELOC_LOONGARCH::R_LARCH_TLS_TPREL32,            32},
    {RELOC_LOONGARCH::R_LARCH_TLS_TPREL64,            64},
    {RELOC_LOONGARCH::R_LARCH_IRELATIVE,              32},
    {RELOC_LOONGARCH::R_LARCH_MARK_LA,                 0},
    {RELOC_LOONGARCH::R_LARCH_MARK_PCREL,              0},
    {RELOC_LOONGARCH::R_LARCH_SOP_PUSH_PCREL,         32},
    {RELOC_LOONGARCH::R_LARCH_SOP_PUSH_ABSOLUTE,      32},
    {RELOC_LOONGARCH::R_LARCH_SOP_PUSH_DUP,           32},
    {RELOC_LOONGARCH::R_LARCH_SOP_PUSH_GPREL,         32},
    {RELOC_LOONGARCH::R_LARCH_SOP_PUSH_TLS_TPREL,     32},
    {RELOC_LOONGARCH::R_LARCH_SOP_PUSH_TLS_GOT,       32},
    {RELOC_LOONGARCH::R_LARCH_SOP_PUSH_TLS_GD,        32},
    {RELOC_LOONGARCH::R_LARCH_SOP_PUSH_PLT_PCREL,     32},
    {RELOC_LOONGARCH::R_LARCH_SOP_ASSERT,             32},
    {RELOC_LOONGARCH::R_LARCH_SOP_NOT,                32},
    {RELOC_LOONGARCH::R_LARCH_SOP_SUB,                32},
    {RELOC_LOONGARCH::R_LARCH_SOP_SL,                 32},
    {RELOC_LOONGARCH::R_LARCH_SOP_SR,                 32},
    {RELOC_LOONGARCH::R_LARCH_SOP_ADD,                32},
    {RELOC_LOONGARCH::R_LARCH_SOP_AND,                32},
    {RELOC_LOONGARCH::R_LARCH_SOP_IF_ELSE,            32},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_S_10_5,       5},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_U_10_12,     12},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_S_10_12,     12},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_S_10_16,     16},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_S_10_16_S2,  16},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_S_5_20,      20},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_S_0_5_10_16_S2,  21},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_S_0_10_10_16_S2, 26},
    {RELOC_LOONGARCH::R_LARCH_SOP_POP_32_U,           32},
    {RELOC_LOONGARCH::R_LARCH_ADD8,                   8},
    {RELOC_LOONGARCH::R_LARCH_ADD16,                  16},
    {RELOC_LOONGARCH::R_LARCH_ADD24,                  24},
    {RELOC_LOONGARCH::R_LARCH_ADD32,                  32},
    {RELOC_LOONGARCH::R_LARCH_ADD64,                  64},
    {RELOC_LOONGARCH::R_LARCH_SUB8,                    8},
    {RELOC_LOONGARCH::R_LARCH_SUB16,                  16},
    {RELOC_LOONGARCH::R_LARCH_SUB24,                  24},
    {RELOC_LOONGARCH::R_LARCH_SUB32,                  32},
    {RELOC_LOONGARCH::R_LARCH_SUB64,                  64},
    {RELOC_LOONGARCH::R_LARCH_GNU_VTINHERIT,           0},
    {RELOC_LOONGARCH::R_LARCH_GNU_VTENTRY,             0},
    {RELOC_LOONGARCH::R_LARCH_B16,                    16},
    {RELOC_LOONGARCH::R_LARCH_B21,                    21},
    {RELOC_LOONGARCH::R_LARCH_B26,                    26},
    {RELOC_LOONGARCH::R_LARCH_ABS_HI20,               20},
    {RELOC_LOONGARCH::R_LARCH_ABS_LO12,               12},
    {RELOC_LOONGARCH::R_LARCH_ABS64_LO20,             20},
    {RELOC_LOONGARCH::R_LARCH_ABS64_HI12,             12},
    {RELOC_LOONGARCH::R_LARCH_PCALA_HI20,             20},
    {RELOC_LOONGARCH::R_LARCH_PCALA_LO12,             12},
    {RELOC_LOONGARCH::R_LARCH_PCALA64_LO20,           20},
    {RELOC_LOONGARCH::R_LARCH_PCALA64_HI12,           12},
    {RELOC_LOONGARCH::R_LARCH_GOT_PC_HI20,            20},
    {RELOC_LOONGARCH::R_LARCH_GOT_PC_LO12,            12},
    {RELOC_LOONGARCH::R_LARCH_GOT64_PC_LO20,          20},
    {RELOC_LOONGARCH::R_LARCH_GOT64_PC_HI12,          12},
    {RELOC_LOONGARCH::R_LARCH_GOT_HI20,               20},
    {RELOC_LOONGARCH::R_LARCH_GOT_LO12,               12},
    {RELOC_LOONGARCH::R_LARCH_GOT64_LO20,             20},
    {RELOC_LOONGARCH::R_LARCH_GOT64_HI12,             12},
    {RELOC_LOONGARCH::R_LARCH_TLS_LE_HI20,            20},
    {RELOC_LOONGARCH::R_LARCH_TLS_LE_LO12,            12},
    {RELOC_LOONGARCH::R_LARCH_TLS_LE64_LO20,          20},
    {RELOC_LOONGARCH::R_LARCH_TLS_LE64_HI12,          12},
    {RELOC_LOONGARCH::R_LARCH_TLS_IE_PC_HI20,         20},
    {RELOC_LOONGARCH::R_LARCH_TLS_IE_PC_LO12,         12},
    {RELOC_LOONGARCH::R_LARCH_TLS_IE64_PC_LO20,       20},
    {RELOC_LOONGARCH::R_LARCH_TLS_IE64_PC_HI12,       12},
    {RELOC_LOONGARCH::R_LARCH_TLS_IE_HI20,            20},
    {RELOC_LOONGARCH::R_LARCH_TLS_IE_LO12,            12},
    {RELOC_LOONGARCH::R_LARCH_TLS_IE64_LO20,          20},
    {RELOC_LOONGARCH::R_LARCH_TLS_IE64_HI12,          12},
    {RELOC_LOONGARCH::R_LARCH_TLS_LD_PC_HI20,         20},
    {RELOC_LOONGARCH::R_LARCH_TLS_LD_HI20,            20},
    {RELOC_LOONGARCH::R_LARCH_TLS_GD_PC_HI20,         20},
    {RELOC_LOONGARCH::R_LARCH_TLS_GD_HI20,            20},
    {RELOC_LOONGARCH::R_LARCH_32_PCREL,               32},
    {RELOC_LOONGARCH::R_LARCH_RELAX,                   0},
};
  const auto it = SIZES.find(R);
  return it == SIZES.end() ? -1 : it->second;
}
