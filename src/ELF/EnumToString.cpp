...
const char* to_string(SYMBOL_BINDINGS e) {
  CONST_MAP(SYMBOL_BINDINGS, const char*, 4)
  enumStrings{
...
const char* to_string(E_TYPE e) {
  CONST_MAP(E_TYPE, const char*, 7)
  enumStrings{{E_TYPE::ET_NONE, "NONE"},       {E_TYPE::ET_REL, "RELOCATABLE"},
              {E_TYPE::ET_EXEC, "EXECUTABLE"}, {E_TYPE::ET_DYN, "DYNAMIC"},
              {E_TYPE::ET_CORE, "CORE"},       {E_TYPE::ET_LOPROC, "LOPROC"},
...
const char* to_string(VERSION e) {
  CONST_MAP(VERSION, const char*, 2)
  enumStrings{{VERSION::EV_NONE, "NONE"}, {VERSION::EV_CURRENT, "CURRENT"}};
  const auto it = enumStrings.find(e);
  return it == enumStrings.end() ? "UNDEFINED" : it->second;
}

const char* to_string(ARCH e) {
  CONST_MAP(ARCH, const char*, 177)
  enumStrings{{ARCH::EM_NONE, "None"},
              {ARCH::EM_M32, "M32"},
              {ARCH::EM_SPARC, "SPARC"},
              {ARCH::EM_386, "i386"},
...
const char* to_string(SEGMENT_TYPES e) {
  CONST_MAP(SEGMENT_TYPES, const char*, 20)
  enumStrings{
...
const char* to_string(DYNAMIC_TAGS e) {
  CONST_MAP(DYNAMIC_TAGS, const char*, 97)
  enumStrings{
      ...
      {DYNAMIC_TAGS::DT_MIPS_RLD_TEXT_RESOLVE_ADDR,
...
const char* to_string(ELF_SECTION_TYPES e) {
  CONST_MAP(ELF_SECTION_TYPES, const char*, 39)
  enumStrings{{ELF_SECTION_TYPES::SHT_NULL, "NULL"},
...
const char* to_string(ELF_SECTION_FLAGS e) {
  CONST_MAP(ELF_SECTION_FLAGS, const char*, 25)
  enumStrings{{ELF_SECTION_FLAGS::SHF_NONE, "NONE"},
...
const char* to_string(ELF_SYMBOL_TYPES e) {
  CONST_MAP(ELF_SYMBOL_TYPES, const char*, 8)
  enumStrings{
...
const char* to_string(RELOC_x86_64 e) {
  CONST_MAP(RELOC_x86_64, const char*, 43)
  enumStrings{
...
const char* to_string(RELOC_ARM e) {
  CONST_MAP(RELOC_ARM, const char*, 138)
  enumStrings{
...
const char* to_string(RELOC_AARCH64 e) {
  CONST_MAP(RELOC_AARCH64, const char*, 123)
  enumStrings{
      ...
      {RELOC_AARCH64::R_AARCH64_TLSLD_MOVW_DTPREL_G1_NC,
       "TLSLD_MOVW_DTPREL_G1_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_MOVW_DTPREL_G0, "TLSLD_MOVW_DTPREL_G0"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_MOVW_DTPREL_G0_NC,
      ...
      {RELOC_AARCH64::R_AARCH64_TLSLD_ADD_DTPREL_LO12_NC,
       "TLSLD_ADD_DTPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST8_DTPREL_LO12,
       "TLSLD_LDST8_DTPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST8_DTPREL_LO12_NC,
       "TLSLD_LDST8_DTPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST16_DTPREL_LO12,
       "TLSLD_LDST16_DTPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST16_DTPREL_LO12_NC,
       "TLSLD_LDST16_DTPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST32_DTPREL_LO12,
       "TLSLD_LDST32_DTPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST32_DTPREL_LO12_NC,
       "TLSLD_LDST32_DTPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST64_DTPREL_LO12,
       "TLSLD_LDST64_DTPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST64_DTPREL_LO12_NC,
       "TLSLD_LDST64_DTPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSIE_MOVW_GOTTPREL_G1,
       "TLSIE_MOVW_GOTTPREL_G1"},
      {RELOC_AARCH64::R_AARCH64_TLSIE_MOVW_GOTTPREL_G0_NC,
       "TLSIE_MOVW_GOTTPREL_G0_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSIE_ADR_GOTTPREL_PAGE21,
       "TLSIE_ADR_GOTTPREL_PAGE21"},
      {RELOC_AARCH64::R_AARCH64_TLSIE_LD64_GOTTPREL_LO12_NC,
       "TLSIE_LD64_GOTTPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSIE_LD_GOTTPREL_PREL19,
      ...
      {RELOC_AARCH64::R_AARCH64_TLSLE_MOVW_TPREL_G1_NC,
      ...
      {RELOC_AARCH64::R_AARCH64_TLSLE_ADD_TPREL_LO12_NC,
       "TLSLE_ADD_TPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST8_TPREL_LO12,
       "TLSLE_LDST8_TPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST8_TPREL_LO12_NC,
       "TLSLE_LDST8_TPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST16_TPREL_LO12,
       "TLSLE_LDST16_TPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST16_TPREL_LO12_NC,
       "TLSLE_LDST16_TPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST32_TPREL_LO12,
       "TLSLE_LDST32_TPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST32_TPREL_LO12_NC,
       "TLSLE_LDST32_TPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST64_TPREL_LO12,
       "TLSLE_LDST64_TPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST64_TPREL_LO12_NC,
      ...
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST128_TPREL_LO12,
       "TLSLE_LDST128_TPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLE_LDST128_TPREL_LO12_NC,
       "TLSLE_LDST128_TPREL_LO12_NC"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST128_DTPREL_LO12,
       "TLSLD_LDST128_DTPREL_LO12"},
      {RELOC_AARCH64::R_AARCH64_TLSLD_LDST128_DTPREL_LO12_NC,
...
const char* to_string(RELOC_i386 e) {
  CONST_MAP(RELOC_i386, const char*, 41)
  enumStrings{
...
const char* to_string(RELOC_POWERPC32 e) {
  CONST_MAP(RELOC_POWERPC32, const char*, 57)
  enumStrings{
...
const char* to_string(RELOC_POWERPC64 e) {
  CONST_MAP(RELOC_POWERPC64, const char*, 84)
  enumStrings{
...
const char* to_string(RELOC_MIPS e) {
  CONST_MAP(RELOC_MIPS, const char*, 112)
  enumStrings{
...
const char* to_string(ELF_CLASS e) {
  CONST_MAP(ELF_CLASS, const char*, 3)
  enumStrings{
...
const char* to_string(ELF_DATA e) {
  CONST_MAP(ELF_DATA, const char*, 3)
  enumStrings{
...
const char* to_string(OS_ABI e) {
  CONST_MAP(OS_ABI, const char*, 23)
  enumStrings{
...
const char* to_string(DYNSYM_COUNT_METHODS e) {
  CONST_MAP(DYNSYM_COUNT_METHODS, const char*, 4)
  enumStrings{
...
const char* to_string(NOTE_TYPES e) {
  CONST_MAP(NOTE_TYPES, const char*, 7)
  enumStrings{
...
const char* to_string(NOTE_TYPES_CORE e) {
  CONST_MAP(NOTE_TYPES_CORE, const char*, 17)
  enumStrings{
...
const char* to_string(NOTE_ABIS e) {
  CONST_MAP(NOTE_ABIS, const char*, 7)
  enumStrings{
...
const char* to_string(RELOCATION_PURPOSES e) {
  CONST_MAP(RELOCATION_PURPOSES, const char*, 4)
  enumStrings{
...
const char* to_string(PPC64_EFLAGS e) {
  CONST_MAP(PPC64_EFLAGS, const char*, 1)
  enumStrings{
...
const char* to_string(ARM_EFLAGS e) {
  CONST_MAP(ARM_EFLAGS, const char*, 8)
  enumStrings{
...
const char* to_string(MIPS_EFLAGS e) {
  CONST_MAP(MIPS_EFLAGS, const char*, 43)
  enumStrings{
...
const char* to_string(HEXAGON_EFLAGS e) {
  CONST_MAP(HEXAGON_EFLAGS, const char*, 9)
  enumStrings{
...
const char* to_string(IDENTITY e) {
  CONST_MAP(IDENTITY, const char*, 11)
  enumStrings{
...
const char* to_string(SYMBOL_SECTION_INDEX e) {
  CONST_MAP(SYMBOL_SECTION_INDEX, const char*, 10)
  enumStrings{
...
const char* to_string(DYNAMIC_FLAGS e) {
  CONST_MAP(DYNAMIC_FLAGS, const char*, 5)
  enum_strings{
...
const char* to_string(DYNAMIC_FLAGS_1 e) {
  CONST_MAP(DYNAMIC_FLAGS_1, const char*, 27)
  enum_strings_flags1{
...
const char* to_string(ELF_SEGMENT_FLAGS e) {
  CONST_MAP(ELF_SEGMENT_FLAGS, const char*, 4)
  enum_strings{
...
const char* to_string(AUX_TYPE e) {
  CONST_MAP(AUX_TYPE, const char*, 32)
  enum_strings{
...
const char* to_string(ELF_SYMBOL_VISIBILITY e) {
  CONST_MAP(ELF_SYMBOL_VISIBILITY, const char*, 4)
  enum_strings{
...
const char* to_string(CorePrStatus::REGISTERS e) {
  CONST_MAP(CorePrStatus::REGISTERS, const char*, 90)
  enum_strings{
