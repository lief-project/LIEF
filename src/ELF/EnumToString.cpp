...
const char* to_string(RELOC_MIPS e) {
  CONST_MAP(RELOC_MIPS, const char*, 111) enumStrings {
    {  RELOC_MIPS::R_MICROMIPS_26_S1,           "26_S1" },
    {  RELOC_MIPS::R_MICROMIPS_CALL16,          "CALL16" },
    {  RELOC_MIPS::R_MICROMIPS_CALL_HI16,       "CALL_HI16" },
    {  RELOC_MIPS::R_MICROMIPS_CALL_LO16,       "CALL_LO16" },
    {  RELOC_MIPS::R_MICROMIPS_GOT16,           "GOT16" },
    {  RELOC_MIPS::R_MICROMIPS_GOT_DISP,        "GOT_DISP" },
    {  RELOC_MIPS::R_MICROMIPS_GOT_HI16,        "GOT_HI16" },
    {  RELOC_MIPS::R_MICROMIPS_GOT_LO16,        "GOT_LO16" },
    {  RELOC_MIPS::R_MICROMIPS_GOT_OFST,        "GOT_OFST" },
    {  RELOC_MIPS::R_MICROMIPS_GOT_PAGE,        "GOT_PAGE" },
    {  RELOC_MIPS::R_MICROMIPS_GPREL16,         "GPREL16" },
    {  RELOC_MIPS::R_MICROMIPS_GPREL7_S2,       "GPREL7_S2" },
    {  RELOC_MIPS::R_MICROMIPS_HI0_LO16,        "HI0_LO16" },
    {  RELOC_MIPS::R_MICROMIPS_HI16,            "HI16" },
    {  RELOC_MIPS::R_MICROMIPS_HIGHER,          "HIGHER" },
    {  RELOC_MIPS::R_MICROMIPS_HIGHEST,         "HIGHEST" },
    {  RELOC_MIPS::R_MICROMIPS_JALR,            "JALR" },
    {  RELOC_MIPS::R_MICROMIPS_LITERAL,         "LITERAL" },
    {  RELOC_MIPS::R_MICROMIPS_LO16,            "LO16" },
    {  RELOC_MIPS::R_MICROMIPS_PC10_S1,         "PC10_S1" },
    {  RELOC_MIPS::R_MICROMIPS_PC16_S1,         "PC16_S1" },
    {  RELOC_MIPS::R_MICROMIPS_PC18_S3,         "PC18_S3" },
    {  RELOC_MIPS::R_MICROMIPS_PC19_S2,         "PC19_S2" },
    {  RELOC_MIPS::R_MICROMIPS_PC21_S2,         "PC21_S2" },
    {  RELOC_MIPS::R_MICROMIPS_PC23_S2,         "PC23_S2" },
    {  RELOC_MIPS::R_MICROMIPS_PC26_S2,         "PC26_S2" },
    {  RELOC_MIPS::R_MICROMIPS_PC7_S1,          "PC7_S1" },
    {  RELOC_MIPS::R_MICROMIPS_SCN_DISP,        "SCN_DISP" },
    {  RELOC_MIPS::R_MICROMIPS_SUB,             "SUB" },
    {  RELOC_MIPS::R_MICROMIPS_TLS_DTPREL_HI16, "TLS_DTPREL_HI16" },
    {  RELOC_MIPS::R_MICROMIPS_TLS_DTPREL_LO16, "TLS_DTPREL_LO16" },
    {  RELOC_MIPS::R_MICROMIPS_TLS_GD,          "TLS_GD" },
    {  RELOC_MIPS::R_MICROMIPS_TLS_GOTTPREL,    "TLS_GOTTPREL" },
    {  RELOC_MIPS::R_MICROMIPS_TLS_LDM,         "TLS_LDM" },
    {  RELOC_MIPS::R_MICROMIPS_TLS_TPREL_HI16,  "TLS_TPREL_HI16" },
    {  RELOC_MIPS::R_MICROMIPS_TLS_TPREL_LO16,  "TLS_TPREL_LO16" },
    {  RELOC_MIPS::R_MIPS_16,                   "16"},
    {  RELOC_MIPS::R_MIPS16_26,                 "26" },
    {  RELOC_MIPS::R_MIPS16_CALL16,             "CALL16" },
    {  RELOC_MIPS::R_MIPS16_GOT16,              "GOT16" },
    {  RELOC_MIPS::R_MIPS16_GPREL,              "GPREL" },
    {  RELOC_MIPS::R_MIPS16_HI16,               "HI16" },
    {  RELOC_MIPS::R_MIPS16_LO16,               "LO16" },
    {  RELOC_MIPS::R_MIPS16_TLS_DTPREL_HI16,    "TLS_DTPREL_HI16" },
    {  RELOC_MIPS::R_MIPS16_TLS_DTPREL_LO16,    "TLS_DTPREL_LO16" },
    {  RELOC_MIPS::R_MIPS16_TLS_GD,             "TLS_GD" },
    {  RELOC_MIPS::R_MIPS16_TLS_GOTTPREL,       "TLS_GOTTPREL" },
    {  RELOC_MIPS::R_MIPS16_TLS_LDM,            "TLS_LDM" },
    {  RELOC_MIPS::R_MIPS16_TLS_TPREL_HI16,     "TLS_TPREL_HI16" },
    {  RELOC_MIPS::R_MIPS16_TLS_TPREL_LO16,     "TLS_TPREL_LO16" },
    {  RELOC_MIPS::R_MIPS_26,                   "26" },
    {  RELOC_MIPS::R_MIPS_32,                   "32" },
    {  RELOC_MIPS::R_MIPS_64,                   "64" },
    {  RELOC_MIPS::R_MIPS_ADD_IMMEDIATE,        "ADD_IMMEDIATE" },
    {  RELOC_MIPS::R_MIPS_CALL16,               "CALL16" },
    {  RELOC_MIPS::R_MIPS_CALL_HI16,            "CALL_HI16" },
    {  RELOC_MIPS::R_MIPS_CALL_LO16,            "CALL_LO16" },
    {  RELOC_MIPS::R_MIPS_COPY,                 "COPY" },
    {  RELOC_MIPS::R_MIPS_DELETE,               "DELETE" },
    {  RELOC_MIPS::R_MIPS_EH,                   "EH" },
    {  RELOC_MIPS::R_MIPS_GLOB_DAT,             "GLOB_DAT" },
    {  RELOC_MIPS::R_MIPS_GOT16,                "GOT16" },
    {  RELOC_MIPS::R_MIPS_GOT_DISP,             "GOT_DISP" },
    {  RELOC_MIPS::R_MIPS_GOT_HI16,             "GOT_HI16" },
    {  RELOC_MIPS::R_MIPS_GOT_LO16,             "GOT_LO16" },
    {  RELOC_MIPS::R_MIPS_GOT_OFST,             "GOT_OFST" },
    {  RELOC_MIPS::R_MIPS_GOT_PAGE,             "GOT_PAGE" },
    {  RELOC_MIPS::R_MIPS_GPREL16,              "GPREL16" },
    {  RELOC_MIPS::R_MIPS_GPREL32,              "GPREL32" },
    {  RELOC_MIPS::R_MIPS_HI16,                 "HI16" },
    {  RELOC_MIPS::R_MIPS_HIGHER,               "HIGHER" },
    {  RELOC_MIPS::R_MIPS_HIGHEST,              "HIGHEST" },
    {  RELOC_MIPS::R_MIPS_INSERT_A,             "INSERT_A" },
    {  RELOC_MIPS::R_MIPS_INSERT_B,             "INSERT_B" },
    {  RELOC_MIPS::R_MIPS_JALR,                 "JALR" },
    {  RELOC_MIPS::R_MIPS_JUMP_SLOT,            "JUMP_SLOT" },
    {  RELOC_MIPS::R_MIPS_LITERAL,              "LITERAL" },
    {  RELOC_MIPS::R_MIPS_LO16,                 "LO16" },
    {  RELOC_MIPS::R_MIPS_NONE,                 "NONE"},
    {  RELOC_MIPS::R_MIPS_NUM,                  "NUM" },
    {  RELOC_MIPS::R_MIPS_PC16,                 "PC16" },
    {  RELOC_MIPS::R_MIPS_PC18_S3,              "PC18_S3" },
    {  RELOC_MIPS::R_MIPS_PC19_S2,              "PC19_S2" },
    {  RELOC_MIPS::R_MIPS_PC21_S2,              "PC21_S2" },
    {  RELOC_MIPS::R_MIPS_PC26_S2,              "PC26_S2" },
    {  RELOC_MIPS::R_MIPS_PC32,                 "PC32" },
    {  RELOC_MIPS::R_MIPS_PCHI16,               "PCHI16" },
    {  RELOC_MIPS::R_MIPS_PCLO16,               "PCLO16" },
    {  RELOC_MIPS::R_MIPS_PJUMP,                "PJUMP" },
    {  RELOC_MIPS::R_MIPS_REL16,                "REL16" },
    {  RELOC_MIPS::R_MIPS_REL32,                "REL32" },
    {  RELOC_MIPS::R_MIPS_RELGOT,               "RELGOT" },
    {  RELOC_MIPS::R_MIPS_SCN_DISP,             "SCN_DISP" },
    {  RELOC_MIPS::R_MIPS_SHIFT5,               "SHIFT5" },
    {  RELOC_MIPS::R_MIPS_SHIFT6,               "SHIFT6" },
    {  RELOC_MIPS::R_MIPS_SUB,                  "SUB" },
    {  RELOC_MIPS::R_MIPS_TLS_DTPMOD32,         "TLS_DTPMOD32" },
    {  RELOC_MIPS::R_MIPS_TLS_DTPMOD64,         "TLS_DTPMOD64" },
    {  RELOC_MIPS::R_MIPS_TLS_DTPREL32,         "TLS_DTPREL32" },
    {  RELOC_MIPS::R_MIPS_TLS_DTPREL64,         "TLS_DTPREL64" },
    {  RELOC_MIPS::R_MIPS_TLS_DTPREL_HI16,      "TLS_DTPREL_HI16" },
    {  RELOC_MIPS::R_MIPS_TLS_DTPREL_LO16,      "TLS_DTPREL_LO16" },
    {  RELOC_MIPS::R_MIPS_TLS_GD,               "TLS_GD" },
    {  RELOC_MIPS::R_MIPS_TLS_GOTTPREL,         "TLS_GOTTPREL" },
    {  RELOC_MIPS::R_MIPS_TLS_LDM,              "TLS_LDM" },
    {  RELOC_MIPS::R_MIPS_TLS_TPREL32,          "TLS_TPREL32" },
    {  RELOC_MIPS::R_MIPS_TLS_TPREL64,          "TLS_TPREL64" },
    {  RELOC_MIPS::R_MIPS_TLS_TPREL_HI16,       "TLS_TPREL_HI16" },
    {  RELOC_MIPS::R_MIPS_TLS_TPREL_LO16,       "TLS_TPREL_LO16" },
    {  RELOC_MIPS::R_MIPS_UNUSED1,              "UNUSED1" },
    {  RELOC_MIPS::R_MIPS_UNUSED2,              "UNUSED2" },
    {  RELOC_MIPS::R_MIPS_UNUSED3,              "UNUSED3" },
  };
  auto   it  = enumStrings.find(e);
  return it == enumStrings.end() ? "UNDEFINED" : it->second;
}
