...
CorePrPsInfo* CorePrPsInfo::clone() const { return new CorePrPsInfo(*this); }

std::string CorePrPsInfo::file_name() const { return file_name_; }

uint64_t CorePrPsInfo::flags() const { return flags_; }

uint32_t CorePrPsInfo::uid() const { return uid_; }

uint32_t CorePrPsInfo::gid() const { return gid_; }

int32_t CorePrPsInfo::pid() const { return pid_; }

int32_t CorePrPsInfo::ppid() const { return ppid_; }

int32_t CorePrPsInfo::pgrp() const { return pgrp_; }

int32_t CorePrPsInfo::sid() const { return sid_; }
...
void CorePrPsInfo::accept(Visitor& visitor) const { visitor.visit(*this); }
...
void CorePrPsInfo::dump(std::ostream& os) const {
  os << std::left;
  os << std::setw(12) << std::setfill(' ') << "File name: " << std::dec
     << file_name() << std::endl;
  os << std::setw(12) << std::setfill(' ') << "UID: " << std::dec << uid()
     << std::endl;
  os << std::setw(12) << std::setfill(' ') << "GID: " << std::dec << gid()
     << std::endl;
  os << std::setw(12) << std::setfill(' ') << "PID: " << std::dec << pid()
     << std::endl;
  os << std::setw(12) << std::setfill(' ') << "PPID: " << std::dec << ppid()
     << std::endl;
  os << std::setw(12) << std::setfill(' ') << "PGRP: " << std::dec << pgrp()
     << std::endl;
  os << std::setw(12) << std::setfill(' ') << "SID: " << std::dec << sid()
     << std::endl;
}
