...
namespace LIEF::ELF {
std::unique_ptr<X86Features> X86Features::create_feat1(X86Features::FLAG flag,
                                                       BinaryStream& stream) {
  ...
  while (bitmask) {
    ...
    switch (bit) {
      case GNU_PROPERTY_X86_FEATURE_1_IBT:
        features.emplace_back(flag, FEATURE::IBT);
        break;
      case GNU_PROPERTY_X86_FEATURE_1_SHSTK:
        features.emplace_back(flag, FEATURE::SHSTK);
        break;
      case GNU_PROPERTY_X86_FEATURE_1_LAM_U48:
        features.emplace_back(flag, FEATURE::LAM_U48);
        break;
      case GNU_PROPERTY_X86_FEATURE_1_LAM_U57:
        features.emplace_back(flag, FEATURE::LAM_U57);
        break;
...
std::unique_ptr<X86Features> X86Features::create_feat2(X86Features::FLAG flag,
                                                       BinaryStream& stream) {
  uint32_t bitmask = stream.read<uint32_t>().value_or(0);
  features_t features;
  while (bitmask) {
    ...
    switch (bit) {
      case GNU_PROPERTY_X86_FEATURE_2_X86:
        features.emplace_back(flag, FEATURE::X86);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_X87:
        features.emplace_back(flag, FEATURE::X87);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_MMX:
        features.emplace_back(flag, FEATURE::MMX);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_XMM:
        features.emplace_back(flag, FEATURE::XMM);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_YMM:
        features.emplace_back(flag, FEATURE::YMM);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_ZMM:
        features.emplace_back(flag, FEATURE::ZMM);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_TMM:
        features.emplace_back(flag, FEATURE::TMM);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_MASK:
        features.emplace_back(flag, FEATURE::MASK);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_FXSR:
        features.emplace_back(flag, FEATURE::FXSR);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_XSAVE:
        features.emplace_back(flag, FEATURE::XSAVE);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_XSAVEOPT:
        features.emplace_back(flag, FEATURE::XSAVEOPT);
        break;
      case GNU_PROPERTY_X86_FEATURE_2_XSAVEC:
        features.emplace_back(flag, FEATURE::XSAVEC);
        break;
      default: features.emplace_back(flag, FEATURE::UNKNOWN); break;
    }
  }
...
std::unique_ptr<X86Features> X86Features::create(uint32_t type,
                                                 BinaryStream& stream) {
  switch (type) {
    ...
    case GNU_PROPERTY_X86_FEATURE_2_NEEDED:
      return create_feat2(FLAG::NEEDED, stream);
...
#define ENTRY(X) std::pair(X86Features::FEATURE::X, #X)
  STRING_MAP enums2str{
      ENTRY(UNKNOWN), ENTRY(IBT),  ENTRY(SHSTK), ENTRY(LAM_U48),  ENTRY(LAM_U57),
      ENTRY(X86),     ENTRY(X87),  ENTRY(MMX),   ENTRY(XMM),      ENTRY(YMM),
      ENTRY(ZMM),     ENTRY(FXSR), ENTRY(XSAVE), ENTRY(XSAVEOPT), ENTRY(XSAVEC),
      ENTRY(TMM),     ENTRY(MASK),
  };
