...
static constexpr auto PFLAGS_LIST = {
    PROCESSOR_FLAGS::ARM_EABI_UNKNOWN,
    PROCESSOR_FLAGS::ARM_SOFT_FLOAT,
    PROCESSOR_FLAGS::ARM_VFP_FLOAT,
    PROCESSOR_FLAGS::ARM_EABI_VER1,
    PROCESSOR_FLAGS::ARM_EABI_VER2,
    PROCESSOR_FLAGS::ARM_EABI_VER3,
    PROCESSOR_FLAGS::ARM_EABI_VER4,
    PROCESSOR_FLAGS::ARM_EABI_VER5,
    PROCESSOR_FLAGS::HEXAGON_MACH_V2,
    PROCESSOR_FLAGS::HEXAGON_MACH_V3,
    PROCESSOR_FLAGS::HEXAGON_MACH_V4,
    PROCESSOR_FLAGS::HEXAGON_MACH_V5,
    PROCESSOR_FLAGS::HEXAGON_ISA_V2,
    PROCESSOR_FLAGS::HEXAGON_ISA_V3,
    PROCESSOR_FLAGS::HEXAGON_ISA_V4,
    PROCESSOR_FLAGS::HEXAGON_ISA_V5,
    PROCESSOR_FLAGS::LOONGARCH_ABI_SOFT_FLOAT,
    PROCESSOR_FLAGS::LOONGARCH_ABI_SINGLE_FLOAT,
    PROCESSOR_FLAGS::LOONGARCH_ABI_DOUBLE_FLOAT,
    PROCESSOR_FLAGS::MIPS_NOREORDER,
    PROCESSOR_FLAGS::MIPS_PIC,
    PROCESSOR_FLAGS::MIPS_CPIC,
    PROCESSOR_FLAGS::MIPS_ABI2,
    PROCESSOR_FLAGS::MIPS_32BITMODE,
    PROCESSOR_FLAGS::MIPS_FP64,
    PROCESSOR_FLAGS::MIPS_NAN2008,
    PROCESSOR_FLAGS::MIPS_ABI_O32,
    PROCESSOR_FLAGS::MIPS_ABI_O64,
    PROCESSOR_FLAGS::MIPS_ABI_EABI32,
    PROCESSOR_FLAGS::MIPS_ABI_EABI64,
    PROCESSOR_FLAGS::MIPS_MACH_3900,
    PROCESSOR_FLAGS::MIPS_MACH_4010,
    PROCESSOR_FLAGS::MIPS_MACH_4100,
    PROCESSOR_FLAGS::MIPS_MACH_4650,
    PROCESSOR_FLAGS::MIPS_MACH_4120,
    PROCESSOR_FLAGS::MIPS_MACH_4111,
    PROCESSOR_FLAGS::MIPS_MACH_SB1,
    PROCESSOR_FLAGS::MIPS_MACH_OCTEON,
    PROCESSOR_FLAGS::MIPS_MACH_XLR,
    PROCESSOR_FLAGS::MIPS_MACH_OCTEON2,
    PROCESSOR_FLAGS::MIPS_MACH_OCTEON3,
    PROCESSOR_FLAGS::MIPS_MACH_5400,
    PROCESSOR_FLAGS::MIPS_MACH_5900,
    PROCESSOR_FLAGS::MIPS_MACH_5500,
    PROCESSOR_FLAGS::MIPS_MACH_9000,
    PROCESSOR_FLAGS::MIPS_MACH_LS2E,
    PROCESSOR_FLAGS::MIPS_MACH_LS2F,
    PROCESSOR_FLAGS::MIPS_MACH_LS3A,
    PROCESSOR_FLAGS::MIPS_MICROMIPS,
    PROCESSOR_FLAGS::MIPS_ARCH_ASE_M16,
    PROCESSOR_FLAGS::MIPS_ARCH_ASE_MDMX,
    PROCESSOR_FLAGS::MIPS_ARCH_1,
    PROCESSOR_FLAGS::MIPS_ARCH_2,
    PROCESSOR_FLAGS::MIPS_ARCH_3,
    PROCESSOR_FLAGS::MIPS_ARCH_4,
    PROCESSOR_FLAGS::MIPS_ARCH_5,
    PROCESSOR_FLAGS::MIPS_ARCH_32,
    PROCESSOR_FLAGS::MIPS_ARCH_64,
    PROCESSOR_FLAGS::MIPS_ARCH_32R2,
    PROCESSOR_FLAGS::MIPS_ARCH_64R2,
    PROCESSOR_FLAGS::MIPS_ARCH_32R6,
...
void Header::identity(const std::string& identity) {
  std::copy(identity.begin(), identity.end(), identity_.begin());
}
...
bool Header::has(PROCESSOR_FLAGS flag) const {
  ...
  if (ID == PF_ARM_ID) {
    ...
    switch (flag) {
      ...
      default: return (processor_flag() & raw_flag) != 0;
    }
  ...
  if (ID == PF_MIPS_ID) {
    ...
    switch (flag) {
      ...
      case PROCESSOR_FLAGS::MIPS_ARCH_ASE_MDMX:
        return (processor_flag() & MIPS_ARCH_ASE_MASK) ==
               (raw_flag & MIPS_ARCH_ASE_MASK);
  ...
  if (ID != 0) {
    LIEF_WARN("Unsupported architecture {} for this flag", to_string(arch));
    return false;
  }
...
std::vector<PROCESSOR_FLAGS> Header::flags_list() const {
  ...
  std::copy_if(PFLAGS_LIST.begin(), PFLAGS_LIST.end(), std::back_inserter(flags),
...
std::ostream& operator<<(std::ostream& os, const Header& hdr) {
  ...
  os << "ELF Header:\n"
     << fmt::format("{:<{}} {:02x}\n", "Magic:", PADDING,
                    fmt::join(hdr.identity(), " "))
     << fmt::format("{:<{}} {}\n", "Class:", PADDING,
                    to_string(hdr.identity_class()))
     << fmt::format("{:<{}} {}\n", "Data:", PADDING,
                    to_string(hdr.identity_data()))
     << fmt::format("{:<{}} {}\n", "Version:", PADDING,
                    to_string(hdr.identity_version()))
     << fmt::format("{:<{}} {}\n", "OS/ABI:", PADDING,
                    to_string(hdr.identity_os_abi()))
     << fmt::format("{:<{}} {}\n", "ABI Version:", PADDING,
                    hdr.identity_abi_version())
     << fmt::format("{:<{}} {}\n", "Type:", PADDING, to_string(hdr.file_type()))
     << fmt::format("{:<{}} {}\n", "Machine:", PADDING,
                    to_string(hdr.machine_type()))
     << fmt::format("{:<{}} {}\n", "Version:", PADDING,
                    to_string(hdr.object_file_version()))
     << fmt::format("{:<{}} {:#010x}\n", "Entry point address:", PADDING,
                    hdr.entrypoint())
     << fmt::format("{:<{}} {} (bytes into file)\n",
                    "Start of program headers:", PADDING,
                    hdr.program_headers_offset())
     << fmt::format("{:<{}} {} (bytes into file)\n",
                    "Start of section headers:", PADDING,
                    hdr.section_headers_offset())
     << fmt::format("{:<{}} {:#x} {}\n", "Flags:", PADDING, hdr.processor_flag(),
                    fmt::to_string(fmt::join(flags_str, ", ")))
     << fmt::format("{:<{}} {} (bytes)\n", "Size of this header:", PADDING,
                    hdr.header_size())
     << fmt::format("{:<{}} {} (bytes)\n", "Size of program headers:", PADDING,
                    hdr.program_header_size())
     << fmt::format("{:<{}} {}\n", "Number of program headers:", PADDING,
                    hdr.numberof_segments())
     << fmt::format("{:<{}} {} (bytes)\n", "Size of section headers:", PADDING,
                    hdr.section_header_size())
     << fmt::format("{:<{}} {}\n", "Number of section headers:", PADDING,
                    hdr.numberof_sections())
     << fmt::format("{:<{}} {}\n", "Section header string table index:", PADDING,
...
#define ENTRY(X) std::pair(Header::OS_ABI::X, #X)
  STRING_MAP enums2str{
      ENTRY(SYSTEMV),     ENTRY(HPUX),     ENTRY(NETBSD),       ENTRY(GNU),
      ENTRY(LINUX),       ENTRY(HURD),     ENTRY(SOLARIS),      ENTRY(AIX),
      ENTRY(IRIX),        ENTRY(FREEBSD),  ENTRY(TRU64),        ENTRY(MODESTO),
      ENTRY(OPENBSD),     ENTRY(OPENVMS),  ENTRY(NSK),          ENTRY(AROS),
      ENTRY(FENIXOS),     ENTRY(CLOUDABI), ENTRY(C6000_ELFABI), ENTRY(AMDGPU_HSA),
      ENTRY(C6000_LINUX), ENTRY(ARM),      ENTRY(STANDALONE),
  };
#undef ENTRY
