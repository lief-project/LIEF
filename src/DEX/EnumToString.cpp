...
const char* to_string(MapItem::TYPES e) {
  CONST_MAP(MapItem::TYPES, const char*, 20)
  enumStrings{
...
const char* to_string(ACCESS_FLAGS e) {
  CONST_MAP(ACCESS_FLAGS, const char*, 18)
  enumStrings{
...
const char* to_string(Type::TYPES e) {
  CONST_MAP(Type::TYPES, const char*, 4)
  enumStrings{
...
const char* to_string(Type::PRIMITIVES e) {
  CONST_MAP(Type::PRIMITIVES, const char*, 9)
  enumStrings{
      {Type::PRIMITIVES::VOID_T, "VOID_T"}, {Type::PRIMITIVES::BOOLEAN, "BOOLEAN"},
      {Type::PRIMITIVES::INT, "INT"},       {Type::PRIMITIVES::SHORT, "SHORT"},
      {Type::PRIMITIVES::LONG, "LONG"},     {Type::PRIMITIVES::CHAR, "CHAR"},
      {Type::PRIMITIVES::DOUBLE, "DOUBLE"}, {Type::PRIMITIVES::FLOAT, "FLOAT"},
