...
const std::string& Field::name() const { return name_; }

bool Field::has_class() const { return parent_ != nullptr; }

const Class* Field::cls() const { return parent_; }

Class* Field::cls() {
  return const_cast<Class*>(static_cast<const Field*>(this)->cls());
}

size_t Field::index() const { return original_index_; }

bool Field::is_static() const { return is_static_; }

void Field::set_static(bool v) { is_static_ = v; }

bool Field::has(ACCESS_FLAGS f) const { return (access_flags_ & f) != 0u; }
...
void Field::accept(Visitor& visitor) const { visitor.visit(*this); }
