...
const char* to_string(PE_TYPE e) {
  CONST_MAP(PE_TYPE, const char*, 2)
  enumStrings{
      {PE_TYPE::PE32, "PE32"},
...
const char* to_string(DATA_DIRECTORY e) {
  CONST_MAP(DATA_DIRECTORY, const char*, 16)
  enumStrings{
...
const char* to_string(MACHINE_TYPES e) {
  CONST_MAP(MACHINE_TYPES, const char*, 26)
  enumStrings{{MACHINE_TYPES::MT_Invalid, "INVALID"},
...
const char* to_string(HEADER_CHARACTERISTICS e) {
  CONST_MAP(HEADER_CHARACTERISTICS, const char*, 15)
  enumStrings{
...
const char* to_string(SUBSYSTEM e) {
  CONST_MAP(SUBSYSTEM, const char*, 14)
  enumStrings{
...
const char* to_string(DLL_CHARACTERISTICS e) {
  CONST_MAP(DLL_CHARACTERISTICS, const char*, 11)
  enumStrings{
...
const char* to_string(SECTION_CHARACTERISTICS e) {
  CONST_MAP(SECTION_CHARACTERISTICS, const char*, 35)
  enumStrings{
...
const char* to_string(PE_SECTION_TYPES e) {
  CONST_MAP(PE_SECTION_TYPES, const char*, 10)
  enumStrings{
...
const char* to_string(SYMBOL_BASE_TYPES e) {
  CONST_MAP(SYMBOL_BASE_TYPES, const char*, 16)
  enumStrings{
...
const char* to_string(SYMBOL_COMPLEX_TYPES e) {
  CONST_MAP(SYMBOL_COMPLEX_TYPES, const char*, 5)
  enumStrings{
...
const char* to_string(SYMBOL_SECTION_NUMBER e) {
  CONST_MAP(SYMBOL_SECTION_NUMBER, const char*, 3)
  enumStrings{
...
const char* to_string(SYMBOL_STORAGE_CLASS e) {
  CONST_MAP(SYMBOL_STORAGE_CLASS, const char*, 24)
  enumStrings{
      {SYMBOL_STORAGE_CLASS::IMAGE_SYM_CLASS_END_OF_FUNCTION,
       "END_OF_FUNCTION"},
      ...
      {SYMBOL_STORAGE_CLASS::IMAGE_SYM_CLASS_UNDEFINED_LABEL,
       "UNDEFINED_LABEL"},
      {SYMBOL_STORAGE_CLASS::IMAGE_SYM_CLASS_MEMBER_OF_STRUCT,
       "MEMBER_OF_STRUCT"},
      {SYMBOL_STORAGE_CLASS::IMAGE_SYM_CLASS_UNION_TAG, "UNION_TAG"},
      {SYMBOL_STORAGE_CLASS::IMAGE_SYM_CLASS_TYPE_DEFINITION,
       "TYPE_DEFINITION"},
      {SYMBOL_STORAGE_CLASS::IMAGE_SYM_CLASS_UNDEFINED_STATIC,
       "UDEFINED_STATIC"},
...
const char* to_string(RELOCATIONS_I386 e) {
  CONST_MAP(RELOCATIONS_I386, const char*, 11)
  enumStrings{
...
const char* to_string(RELOCATIONS_AMD64 e) {
  CONST_MAP(RELOCATIONS_AMD64, const char*, 17)
  enumStrings{
...
const char* to_string(RELOCATIONS_ARM e) {
  CONST_MAP(RELOCATIONS_ARM, const char*, 15)
  enumStrings{
...
const char* to_string(RELOCATIONS_BASE_TYPES e) {
  CONST_MAP(RELOCATIONS_BASE_TYPES, const char*, 19)
  enumStrings{
      ...
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_MIPS_JMPADDR,
       "MIPS_JMPADDR | ARM_MOV32A | ARM_MOV32 | RISCV_HI20"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_ARM_MOV32A,
       "MIPS_JMPADDR | ARM_MOV32A | ARM_MOV32 | RISCV_HI20"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_ARM_MOV32,
       "MIPS_JMPADDR | ARM_MOV32A | ARM_MOV32 | RISCV_HI20"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_RISCV_HI20,
       "MIPS_JMPADDR | ARM_MOV32A | ARM_MOV32 | RISCV_HI20"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_SECTION, "SECTION"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_REL,
       "REL | ARM_MOV32T | THUMB_MOV32 | RISCV_LOW12I"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_ARM_MOV32T,
       "REL | ARM_MOV32T | THUMB_MOV32 | RISCV_LOW12I"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_THUMB_MOV32,
       "REL | ARM_MOV32T | THUMB_MOV32 | RISCV_LOW12I"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_RISCV_LOW12I,
       "REL | ARM_MOV32T | THUMB_MOV32 | RISCV_LOW12I"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_RISCV_LOW12S, "RISCV_LOW12S"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_MIPS_JMPADDR16,
       "MIPS_JMPADDR16 | IA64_IMM64"},
      {RELOCATIONS_BASE_TYPES::IMAGE_REL_BASED_IA64_IMM64,
       "MIPS_JMPADDR16 | IA64_IMM64"},
...
const char* to_string(DEBUG_TYPES e) {
  CONST_MAP(DEBUG_TYPES, const char*, 18)
  enumStrings{
      ...
      {DEBUG_TYPES::IMAGE_DEBUG_TYPE_EX_DLLCHARACTERISTICS,
...
const char* to_string(RESOURCE_TYPES e) {
  CONST_MAP(RESOURCE_TYPES, const char*, 21)
  enumStrings{
...
const char* to_string(RESOURCE_LANGS e) {
  CONST_MAP(RESOURCE_LANGS, const char*, 98)
  enumStrings{
...
const char* to_string(RESOURCE_SUBLANGS e) {
  CONST_MAP(RESOURCE_SUBLANGS, const char*, 229)
  enumStrings{
...
const char* to_string(EXTENDED_WINDOW_STYLES e) {
  CONST_MAP(EXTENDED_WINDOW_STYLES, const char*, 17)
  enumStrings{
...
const char* to_string(WINDOW_STYLES e) {
  CONST_MAP(WINDOW_STYLES, const char*, 18)
  enumStrings{
...
const char* to_string(DIALOG_BOX_STYLES e) {
  CONST_MAP(DIALOG_BOX_STYLES, const char*, 15)
  enumStrings{
...
const char* to_string(FIXED_VERSION_OS e) {
  CONST_MAP(FIXED_VERSION_OS, const char*, 14)
  enumStrings{
...
const char* to_string(FIXED_VERSION_FILE_FLAGS e) {
  CONST_MAP(FIXED_VERSION_FILE_FLAGS, const char*, 6)
  enumStrings{
...
const char* to_string(FIXED_VERSION_FILE_TYPES e) {
  CONST_MAP(FIXED_VERSION_FILE_TYPES, const char*, 7)
  enumStrings{
...
const char* to_string(FIXED_VERSION_FILE_SUB_TYPES e) {
  CONST_MAP(FIXED_VERSION_FILE_SUB_TYPES, const char*, 12)
  enumStrings{
      ...
      {FIXED_VERSION_FILE_SUB_TYPES::VFT2_DRV_VERSIONED_PRINTER,
...
const char* to_string(CODE_PAGES e) {
  CONST_MAP(CODE_PAGES, const char*, 140)
  enumStrings{
...
const char* to_string(WIN_VERSION e) {
  CONST_MAP(WIN_VERSION, const char*, 9)
  enumStrings{
...
const char* to_string(GUARD_CF_FLAGS e) {
  CONST_MAP(GUARD_CF_FLAGS, const char*, 10)
  enumStrings{
...
const char* to_string(CODE_VIEW_SIGNATURES e) {
  CONST_MAP(CODE_VIEW_SIGNATURES, const char*, 5)
  enumStrings{
...
const char* to_string(POGO_SIGNATURES e) {
  CONST_MAP(POGO_SIGNATURES, const char*, 3)
  enumStrings{
...
const char* to_string(ACCELERATOR_FLAGS e) {
  CONST_MAP(ACCELERATOR_FLAGS, const char*, 6)
  enumStrings{
...
const char* to_string(ACCELERATOR_VK_CODES e) {
  CONST_MAP(ACCELERATOR_VK_CODES, const char*, 174)
  enumStrings{
...
const char* to_string(SIG_ATTRIBUTE_TYPES e) {
  CONST_MAP(SIG_ATTRIBUTE_TYPES, const char*, 11)
  enumStrings{
      ...
      {SIG_ATTRIBUTE_TYPES::PKCS9_AT_SEQUENCE_NUMBER,
