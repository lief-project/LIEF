...
#define MBEDTLS_OID_PKCS7                                                         \
  MBEDTLS_OID_PKCS "\x07" /**< pkcs-7 OBJECT IDENTIFIER ::= { iso(1)              \
                             member-body(2) US(840) rsadsi(113549) pkcs(1) 7 } */
...
/* MS Specific OID */
#define MS_SZOID_PLATFORM_MANIFEST_BINARY_ID                                      \
  "\x06\x0A\x2B\x06\x01\x04\x01\x82\x37\x0A\x03\x1C"
