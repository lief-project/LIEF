...
PKCS9AtSequenceNumber::PKCS9AtSequenceNumber(const PKCS9AtSequenceNumber&) =
    default;
PKCS9AtSequenceNumber& PKCS9AtSequenceNumber::operator=(
    const PKCS9AtSequenceNumber&) = default;
...
PKCS9AtSequenceNumber::PKCS9AtSequenceNumber(uint32_t num)
    : Attribute(SIG_ATTRIBUTE_TYPES::PKCS9_AT_SEQUENCE_NUMBER), number_{num} {}
