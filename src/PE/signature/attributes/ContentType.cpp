...
ContentType::ContentType() : Attribute(SIG_ATTRIBUTE_TYPES::CONTENT_TYPE) {}
...
ContentType::ContentType(oid_t oid)
    : Attribute(SIG_ATTRIBUTE_TYPES::CONTENT_TYPE), oid_{std::move(oid)} {}

void ContentType::accept(Visitor& visitor) const { visitor.visit(*this); }
