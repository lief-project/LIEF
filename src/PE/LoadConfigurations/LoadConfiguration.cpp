...
LoadConfiguration& LoadConfiguration::operator=(const LoadConfiguration&) =
    default;
LoadConfiguration::LoadConfiguration(const LoadConfiguration&) = default;
LoadConfiguration::~LoadConfiguration() = default;

decltype(details::PE32::load_configuration_sizes)
    details::PE32::load_configuration_sizes = {
...
decltype(details::PE64::load_configuration_sizes)
    details::PE64::load_configuration_sizes = {
...
uint32_t LoadConfiguration::characteristics() const { return characteristics_; }

uint32_t LoadConfiguration::size() const { return characteristics_; }

uint32_t LoadConfiguration::timedatestamp() const { return timedatestamp_; }

uint16_t LoadConfiguration::major_version() const { return major_version_; }

uint16_t LoadConfiguration::minor_version() const { return minor_version_; }
...
uint16_t LoadConfiguration::csd_version() const { return csd_version_; }

uint16_t LoadConfiguration::reserved1() const { return reserved1_; }

uint16_t LoadConfiguration::dependent_load_flags() const { return reserved1_; }

uint32_t LoadConfiguration::editlist() const { return editlist_; }

uint32_t LoadConfiguration::security_cookie() const { return security_cookie_; }
...
void LoadConfiguration::maximum_allocation_size(
    uint64_t maximum_allocation_size) {
  maximum_allocation_size_ = maximum_allocation_size;
}

void LoadConfiguration::virtual_memory_threshold(
...
void LoadConfiguration::editlist(uint32_t editlist) { editlist_ = editlist; }

void LoadConfiguration::security_cookie(uint32_t security_cookie) {
  security_cookie_ = security_cookie;
}

void LoadConfiguration::accept(Visitor& visitor) const { visitor.visit(*this); }
...
std::ostream& LoadConfiguration::print(std::ostream& os) const {
  ...
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Version:" << std::hex << to_string(version()) << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Characteristics:" << std::hex << characteristics() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Timedatestamp:" << std::dec << timedatestamp() << std::endl;

  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Major version:" << std::dec << major_version() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Minor version:" << std::dec << minor_version() << std::endl;

  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Global flags clear:" << std::hex << global_flags_clear() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Global flags set:" << std::hex << global_flags_set() << std::endl;

  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Critical section default timeout:" << std::dec
     << critical_section_default_timeout() << std::endl;

  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Decommit free block threshold:" << std::hex
     << decommit_free_block_threshold() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Decommit total free threshold:" << std::hex
     << decommit_total_free_threshold() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Lock prefix table:" << std::hex << lock_prefix_table() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Maximum allocation size:" << std::hex << maximum_allocation_size()
     << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Virtual memory threshold:" << std::hex << virtual_memory_threshold()
     << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Process affinity mask:" << std::hex << process_affinity_mask()
     << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Process heap flags:" << std::hex << process_heap_flags() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "CSD Version:" << std::hex << csd_version() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Reserved 1:" << std::hex << reserved1() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Edit list:" << std::hex << editlist() << std::endl;
  os << std::setw(LoadConfiguration::PRINT_WIDTH) << std::setfill(' ')
     << "Security cookie:" << std::hex << security_cookie() << std::endl;
  return os;
}
