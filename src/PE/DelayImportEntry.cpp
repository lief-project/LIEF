...
DelayImportEntry& DelayImportEntry::operator=(const DelayImportEntry&) =
    default;
...
uint16_t DelayImportEntry::ordinal() const { return data_ & 0xFFFF; }

uint16_t DelayImportEntry::hint() const { return hint_; }

uint64_t DelayImportEntry::iat_value() const { return iat_value_; }

uint64_t DelayImportEntry::hint_name_rva() const { return data(); }

uint64_t DelayImportEntry::data() const { return data_; }

void DelayImportEntry::data(uint64_t data) { data_ = data; }
