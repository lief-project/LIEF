...
PE_TYPE OptionalHeader::magic() const { return magic_; }
...
uint32_t OptionalHeader::sizeof_code() const { return sizeOfCode_; }
...
uint32_t OptionalHeader::baseof_code() const { return baseOfCode_; }
...
uint64_t OptionalHeader::imagebase() const { return imageBase_; }

uint32_t OptionalHeader::section_alignment() const { return sectionAlignment_; }

uint32_t OptionalHeader::file_alignment() const { return fileAlignment_; }
...
uint32_t OptionalHeader::sizeof_image() const { return sizeOfImage_; }

uint32_t OptionalHeader::sizeof_headers() const { return sizeOfHeaders_; }

uint32_t OptionalHeader::checksum() const { return checkSum_; }

SUBSYSTEM OptionalHeader::subsystem() const { return subsystem_; }
...
uint32_t OptionalHeader::loader_flags() const { return loaderFlags_; }
...
std::set<DLL_CHARACTERISTICS> OptionalHeader::dll_characteristics_list() const {
  ...
  std::copy_if(std::begin(details::dll_characteristics_array),
...
void OptionalHeader::sizeof_uninitialized_data(
...
void OptionalHeader::imagebase(uint64_t imageBase) { imageBase_ = imageBase; }
...
void OptionalHeader::major_operating_system_version(
    uint16_t majorOperatingSystemVersion) {
  majorOperatingSystemVersion_ = majorOperatingSystemVersion;
}

void OptionalHeader::minor_operating_system_version(
...
void OptionalHeader::checksum(uint32_t checkSum) { checkSum_ = checkSum; }

void OptionalHeader::subsystem(SUBSYSTEM subsystem) { subsystem_ = subsystem; }
...
std::ostream& operator<<(std::ostream& os, const OptionalHeader& entry) {
  ...
  std::string dll_chara_str =
      std::accumulate(std::begin(dll_chara), std::end(dll_chara), std::string{},
  ...
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Magic: " << static_cast<uint32_t>(entry.magic()) << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Major Linker Version: "
     << static_cast<uint32_t>(entry.major_linker_version()) << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Minor Linker Version: "
     << static_cast<uint32_t>(entry.minor_linker_version()) << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Code: " << entry.sizeOfCode_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Initialized Data: " << entry.sizeOfInitializedData_
     << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Uninitialized Data: " << entry.sizeOfUninitializedData_
     << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Address Of Entry Point: " << entry.addressOfEntryPoint_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Base Of Code: " << entry.baseOfCode_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Base Of Data: " << entry.baseOfData_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Image Base: " << entry.imageBase_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Section Alignment: " << entry.sectionAlignment_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "File Alignment: " << entry.fileAlignment_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Major Operating System Version: " << entry.majorOperatingSystemVersion_
     << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Minor Operating System Version: " << entry.minorOperatingSystemVersion_
     << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Major Image Version: " << entry.majorImageVersion_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Minor Image Version: " << entry.minorImageVersion_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Major Subsystem Version: " << entry.majorSubsystemVersion_
     << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Minor Subsystem Version: " << entry.minorSubsystemVersion_
     << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Win32 Version Value: " << entry.win32VersionValue_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Image: " << entry.sizeOfImage_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Headers: " << entry.sizeOfHeaders_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "CheckSum: " << entry.checkSum_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Subsystem: " << to_string(entry.subsystem_) << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "DLL Characteristics: " << dll_chara_str << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Stack Reserve: " << entry.sizeOfStackReserve_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Stack Commit: " << entry.sizeOfStackCommit_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Heap Reserve: " << entry.sizeOfHeapReserve_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Size Of Heap Commit: " << entry.sizeOfHeapCommit_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Loader Flags: " << entry.loaderFlags_ << std::endl;
  os << std::setw(33) << std::left << std::setfill(' ')
     << "Number Of RVA And Size: " << entry.numberOfRvaAndSize_ << std::endl;
