...
technique [^f1] [^f2], and this tutorial focuses on its implementation using
LIEF.
...
{{ literalinclude("../../code/python/tuto_elf_plt_got.py", "inject", prepend="import lief") }}
...
{{ literalinclude("../../code/python/tuto_elf_plt_got.py", "hook-address") }}

Finally, we can patch `memcmp` from the crackme with this value:

{{ literalinclude("../../code/python/tuto_elf_plt_got.py", "patch-got") }}

And rebuild it:

{{ literalinclude("../../code/python/tuto_elf_plt_got.py", "rebuild") }}
