...
```{raw} html
<hr />
<img src="../../_static/lief_with_bn.webp"
     alt="LIEF integrated with Binary Ninja"
...
or from here: {sub-ref}`lief-sdk-url`. Some plugins (like the {ref}`DWARF Plugin <plugins-binaryninja-dwarf>`)
