(plugins-binaryninja-analyzers-loadconfig)=
...
{sub-ref}`lief-pe-loadconfig` interface -- evolves frequently across new Windows releases.
...
{sub-ref}`lief-pe-chpe_metadata-arm64`, which provide valuable context for analyzing ARM64EC binaries.
