...
[PEP 517](https://peps.python.org/pep-0517/) build backend based on
...
:::{note}
You can speed up the compilation by installing [ccache](https://ccache.dev/)
or [sccache](https://github.com/mozilla/sccache).
:::
...
rather than using vendored dependencies [^ref-issue] [^ref-vcpk].
...
[^ref-issue]: <https://github.com/lief-project/LIEF/issues/605>

[^ref-vcpk]: <https://learn.microsoft.com/en-us/vcpkg/contributing/maintainer-guide#do-not-use-vendored-dependencies>
...
In particular, [scripts/docker/linux-sdk-x64](https://github.com/lief-project/LIEF/blob/main/scripts/docker/linux-sdk-x64)
contains the build process to generate the **Linux x86-64 SDK**.

On Windows, the SDK is built with the following Python script:
[scripts/windows/package_sdk.py](https://github.com/lief-project/LIEF/blob/main/scripts/windows/package_sdk.py)

For **OSX**, refer to the CI config [.github/workflows/osx.yml](https://github.com/lief-project/LIEF/blob/main/.github/workflows/osx.yml),
and for **iOS**, see the [scripts/osx/package_ios.sh](https://github.com/lief-project/LIEF/blob/main/scripts/osx/package_ios.sh)
