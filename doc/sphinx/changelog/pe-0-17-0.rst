...
1. Join our Discord server and ask your questions: |lief-discord|
...
|lief-pe-loadconfig|, regularly evolve with new Windows releases.
...
|lief-pe-loadconfig| previously used a form of inheritance. For each new
...
Starting with LIEF v0.17.0, |lief-pe-loadconfig| has adopted a **flat**
...
Additionally, |lief-pe-loadconfig| now provides an API that allows access to
...
Given a |lief-pe-binary| instance, one can iterate over these
|lief-pe-exceptioninfo| entries using |lief-pe-binary-exceptions|:
...
.. admonition:: Performance Considerations
  ...
  the 0.16.x version.
  Therefore, |lief-pe-parser-config-parse_arm64x_binary| must be
  **explicitly** enabled.
