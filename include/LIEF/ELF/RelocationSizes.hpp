...
CONST_MAP(RELOC_x86_64, uint32_t, 43)
relocation_x86_64_sizes{
...
CONST_MAP(RELOC_i386, uint32_t, 40)
relocation_i386_sizes{
...
CONST_MAP(RELOC_ARM, uint32_t, 138)
relocation_ARM_sizes{
...
CONST_MAP(RELOC_AARCH64, uint32_t, 123)
relocation_AARCH64_sizes{
...
CONST_MAP(RELOC_POWERPC32, uint32_t, 57)
relocation_PPC_sizes{
...
CONST_MAP(RELOC_POWERPC64, uint32_t, 84)
relocation_PPC64_sizes{
...
CONST_MAP(RELOC_MIPS, uint32_t, 112)
relocation_MIPS_sizes{
