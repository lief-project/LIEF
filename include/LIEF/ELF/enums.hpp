...
enum class ELF_SECTION_TYPES : size_t {
  ...
  SHT_LLVM_ADDRSIG = 0x6fff4c03, /**< This section is used to mark symbols as
                                    address-significant. */
...
enum class ELF_SECTION_FLAGS : size_t {
  ...
  SHF_OS_NONCONFORMING = 0x100U, /**< This section requires special OS-specific
  ...
  SHF_EXCLUDE = 0x80000000U, /**< This section is excluded from the final
...
enum class DYNAMIC_TAGS : size_t {
  ...
  DT_FLAGS = 30,        /**< Flags. */
  DT_ENCODING = 32, /**< Values from here to DT_LOOS follow the rules for the
  ...
  DT_MIPS_PERF_SUFFIX = 0x7000002E, /**< Default suffix of DSO to be added by
                                       rld on dlopen() calls. */
  ...
  DT_ANDROID_REL_OFFSET =
      0x6000000D, /**< The offset of packed relocation data (older version < M)
                     (Android specific). */
  DT_ANDROID_REL_SIZE =
      0x6000000E, /**< The size of packed relocation data in bytes (older
                     version < M) (Android specific). */
  DT_ANDROID_REL = 0x6000000F,    /**< The offset of packed relocation data
                                     (Android specific). */
  DT_ANDROID_RELSZ = 0x60000010,  /**< The size of packed relocation data in
                                     bytes (Android specific). */
  DT_ANDROID_RELA = 0x60000011,   /**< The offset of packed relocation data
                                     (Android specific). */
  DT_ANDROID_RELASZ = 0x60000012, /**< The size of packed relocation data in
                                     bytes (Android specific). */
  DT_RELR = 0x6FFFE000,    /**< The offset of new relr relocation data (Android
                              specific). */
  DT_RELRSZ = 0x6FFFE001,  /**< The size of nre relr relocation data in bytes
                              (Android specific). */
  DT_RELRENT = 0x6FFFE003, /**< The size of a new relr relocation entry (Android
                              specific). */
  DT_RELRCOUNT = 0x6FFFE005 /**< Specifies the relative count of new relr
...
enum class DYNSYM_COUNT_METHODS : size_t {
  ...
  COUNT_RELOCATIONS = 3, /**< Count based on PLT/GOT relocations (very reliable
                            but not accurate) */
};
