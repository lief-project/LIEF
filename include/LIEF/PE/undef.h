...
#undef SUBLANG_DUTCH_SURINAM
#undef SUBLANG_ROMANIAN
#undef SUBLANG_ROMANIAN_MOLDAVIA
#undef SUBLANG_RUSSIAN
#undef SUBLANG_RUSSIAN_MOLDAVIA
#undef SUBLANG_CROATIAN
#undef SUBLANG_LITHUANIAN_CLASSIC
#undef SUBLANG_GAELIC
#undef SUBLANG_GAELIC_SCOTTISH
#undef SUBLANG_GAELIC_MANX
