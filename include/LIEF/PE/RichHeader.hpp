...
//! It is generated by the Microsoft linker `link.exe` and there are no options
//! to disable or remove this information.
class LIEF_API RichHeader : public Object {
 public:
  ...
  //! Compute the hash of the rich header structure encoded with the provided
  //! key.
