...
class LIEF_API Import : public Object {
 ...
 public:
  ...
  //! After the image is bound, this field is set to the time/data stamp of the
  //! DLL
  ...
  //! The RVA of the import address table (``IAT``). The content of this table
  //! is
  //! **identical** to the content of the Import Lookup Table (``ILT``) until
  //! the image is bound.
  //!
  //! @warning
