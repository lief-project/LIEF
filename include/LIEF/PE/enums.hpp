...
enum class HEADER_CHARACTERISTICS : size_t {
  ...
  IMAGE_FILE_RELOCS_STRIPPED =
      0x0001, /**< The file does not contain base relocations and must be loaded
                 at its preferred base. If this cannot be done, the loader will
                 error.*/
  IMAGE_FILE_EXECUTABLE_IMAGE = 0x0002, /**< The file is valid and can be run.*/
  IMAGE_FILE_LINE_NUMS_STRIPPED =
      0x0004, /**< COFF line numbers have been stripped. This is deprecated and
                 should be 0*/
  IMAGE_FILE_LOCAL_SYMS_STRIPPED =
      0x0008, /**< COFF symbol table entries for local symbols have been
                 removed. This is deprecated and should be 0.*/
  IMAGE_FILE_AGGRESSIVE_WS_TRIM = 0x0010, /**< Aggressively trim working set.
                                             This is deprecated and must be 0.*/
  IMAGE_FILE_LARGE_ADDRESS_AWARE =
      0x0020, /**< Image can handle > 2GiB addresses. */
  IMAGE_FILE_BYTES_REVERSED_LO =
      0x0080, /**< Little endian: the LSB precedes the MSB in memory. This is
  ...
  IMAGE_FILE_REMOVABLE_RUN_FROM_SWAP =
      0x0400, /**< If the image is on removable media, fully load it and copy it
                 to swap. */
  IMAGE_FILE_NET_RUN_FROM_SWAP =
      0x0800, /**< If the image is on network media, fully load it and copy it
                 to swap. */
  IMAGE_FILE_SYSTEM =
  ...
  IMAGE_FILE_BYTES_REVERSED_HI = 0x8000 /**< Big endian: the MSB precedes the
                                           LSB in memory. This is deprecated */
};
...
enum SYMBOL_STORAGE_CLASS : int {
  ...
  IMAGE_SYM_CLASS_BIT_FIELD =
      18,  ///< Bit field ".bb" or ".eb" - beginning or end of block
  IMAGE_SYM_CLASS_BLOCK =
      100,  ///< ".bf" or ".ef" - beginning or end of function
  IMAGE_SYM_CLASS_FUNCTION = 101,
  IMAGE_SYM_CLASS_END_OF_STRUCT = 102,  ///< End of structure
  IMAGE_SYM_CLASS_FILE = 103,  ///< File name line number, reformatted as symbol
  IMAGE_SYM_CLASS_SECTION = 104,
  IMAGE_SYM_CLASS_WEAK_EXTERNAL =
      105,  ///< Duplicate tag external symbol in dmert public lib
...
enum class DLL_CHARACTERISTICS : size_t {
  ...
  IMAGE_DLL_CHARACTERISTICS_NO_SEH =
      0x0400,  ///< Does not use structured exception handling (SEH). No SEH
...
enum class CODE_PAGES : size_t {
  ...
  CP_IBM870 = 870,   /**< IBM EBCDIC Multilingual/ROECE (Latin 2); IBM EBCDIC
  ...
  CP_GB2312 = 936,    /**< ANSI/OEM Simplified Chinese (PRC, Singapore); Chinese
                         Simplified (GB2312) */
  CP_KS_C_5601_1987 = 949, /**< ANSI/OEM Korean (Unified Hangul Code) */
  CP_BIG5 = 950, /**< ANSI/OEM Traditional Chinese (Taiwan; Hong Kong SAR, PRC);
                    Chinese Traditional (Big5) */
  CP_IBM1026 = 1026,  /**< IBM EBCDIC Turkish (Latin 5) */
  CP_IBM01047 = 1047, /**< IBM EBCDIC Latin 1/Open System */
  CP_IBM01140 = 1140, /**< IBM EBCDIC US-Canada (037 + Euro symbol); IBM EBCDIC
                         (US-Canada-Euro) */
  CP_IBM01141 = 1141, /**< IBM EBCDIC Germany (20273 + Euro symbol); IBM EBCDIC
                         (Germany-Euro) */
  CP_IBM01142 = 1142, /**< IBM EBCDIC Denmark-Norway (20277 + Euro symbol); IBM
                         EBCDIC (Denmark-Norway-Euro) */
  CP_IBM01143 = 1143, /**< IBM EBCDIC Finland-Sweden (20278 + Euro symbol); IBM
                         EBCDIC (Finland-Sweden-Euro) */
  CP_IBM01144 = 1144, /**< IBM EBCDIC Italy (20280 + Euro symbol); IBM EBCDIC
                         (Italy-Euro) */
  CP_IBM01145 = 1145, /**< IBM EBCDIC Latin America-Spain (20284 + Euro symbol);
                         IBM EBCDIC (Spain-Euro) */
  CP_IBM01146 = 1146, /**< IBM EBCDIC United Kingdom (20285 + Euro symbol); IBM
                         EBCDIC (UK-Euro) */
  CP_IBM01147 = 1147, /**< IBM EBCDIC France (20297 + Euro symbol); IBM EBCDIC
                         (France-Euro) */
  CP_IBM01148 = 1148, /**< IBM EBCDIC International (500 + Euro symbol); IBM
                         EBCDIC (International-Euro) */
  CP_IBM01149 = 1149, /**< IBM EBCDIC Icelandic (20871 + Euro symbol); IBM
                         EBCDIC (Icelandic-Euro) */
  CP_UTF_16 = 1200,   /**< Unicode UTF-16, little endian byte order (BMP of ISO
                         10646); available only to managed applications */
  CP_UNICODEFFFE = 1201, /**< Unicode UTF-16, big endian byte order; available
  ...
  CP_UTF_32 = 12000,   /**< Unicode UTF-32, little endian byte order; available
                          only to managed applications */
  CP_UTF_32BE = 12001, /**< Unicode UTF-32, big endian byte order; available
                          only to managed applications */
  ...
  CP_X_IA5 = 20105, /**< IA5 (IRV International Alphabet No. 5, 7-bit); Western
                       European (IA5) */
  ...
  CP_ISO_2022_JP = 50220,     /**< ISO 2022 Japanese with no halfwidth Katakana;
                                 Japanese (JIS) */
  CP_CSISO2022JP = 50221,     /**< ISO 2022 Japanese with halfwidth Katakana;
                                 Japanese (JIS-Allow 1 byte Kana) */
  CP_ISO_2022_JP_JIS = 50222, /**< ISO 2022 Japanese JIS X 0201-1989; Japanese
  ...
  CP_GB18030 = 54936, /**< Windows XP and later: GB18030 Simplified Chinese (4
...
enum class GUARD_CF_FLAGS : size_t {
  GCF_NONE = 0x00000000,
  GCF_INSTRUMENTED = 0x00000100,   /**< Module performs control flow integrity
                                      checks using system-supplied support */
  GCF_W_INSTRUMENTED = 0x00000200, /**< Module performs control flow and write
                                      integrity checks */
  ...
  GCF_EXPORT_SUPPRESSION_INFO_PRESENT =
      0x00004000, /**< Module contains suppressed export information. This also
                     infers that the address taken taken IAT table is also
                     present in the load config. */
  ...
  GRF_INSTRUMENTED = 0x00020000, /**< Module contains return flow
                                    instrumentation and metadata */
  GRF_ENABLE = 0x00040000, /**< Module requests that the OS enable return flow
                              protection */
  GRF_STRICT = 0x00080000, /**< Module requests that the OS enable return flow
                              protection in strict mode */
};
...
static const RESOURCE_TYPES resource_types_array[] = {
    RESOURCE_TYPES::CURSOR,       RESOURCE_TYPES::BITMAP,
    RESOURCE_TYPES::ICON,         RESOURCE_TYPES::MENU,
    RESOURCE_TYPES::DIALOG,       RESOURCE_TYPES::STRING,
    RESOURCE_TYPES::FONTDIR,      RESOURCE_TYPES::FONT,
    RESOURCE_TYPES::ACCELERATOR,  RESOURCE_TYPES::RCDATA,
    RESOURCE_TYPES::MESSAGETABLE, RESOURCE_TYPES::GROUP_CURSOR,
    RESOURCE_TYPES::GROUP_ICON,   RESOURCE_TYPES::VERSION,
    RESOURCE_TYPES::DLGINCLUDE,   RESOURCE_TYPES::PLUGPLAY,
    RESOURCE_TYPES::VXD,          RESOURCE_TYPES::ANICURSOR,
    RESOURCE_TYPES::ANIICON,      RESOURCE_TYPES::HTML,
    RESOURCE_TYPES::MANIFEST,
};

static const RESOURCE_LANGS resource_langs_array[] = {
    RESOURCE_LANGS::LANG_NEUTRAL,    RESOURCE_LANGS::LANG_INVARIANT,
    RESOURCE_LANGS::LANG_AFRIKAANS,  RESOURCE_LANGS::LANG_ALBANIAN,
    RESOURCE_LANGS::LANG_ARABIC,     RESOURCE_LANGS::LANG_ARMENIAN,
    RESOURCE_LANGS::LANG_ASSAMESE,   RESOURCE_LANGS::LANG_AZERI,
    RESOURCE_LANGS::LANG_BASQUE,     RESOURCE_LANGS::LANG_BELARUSIAN,
    RESOURCE_LANGS::LANG_BANGLA,     RESOURCE_LANGS::LANG_BULGARIAN,
    RESOURCE_LANGS::LANG_CATALAN,    RESOURCE_LANGS::LANG_CHINESE,
    RESOURCE_LANGS::LANG_CROATIAN,   RESOURCE_LANGS::LANG_BOSNIAN,
    RESOURCE_LANGS::LANG_CZECH,      RESOURCE_LANGS::LANG_DANISH,
    RESOURCE_LANGS::LANG_DIVEHI,     RESOURCE_LANGS::LANG_DUTCH,
    RESOURCE_LANGS::LANG_ENGLISH,    RESOURCE_LANGS::LANG_ESTONIAN,
    RESOURCE_LANGS::LANG_FAEROESE,   RESOURCE_LANGS::LANG_FARSI,
    RESOURCE_LANGS::LANG_FINNISH,    RESOURCE_LANGS::LANG_FRENCH,
    RESOURCE_LANGS::LANG_GALICIAN,   RESOURCE_LANGS::LANG_GEORGIAN,
    RESOURCE_LANGS::LANG_GERMAN,     RESOURCE_LANGS::LANG_GREEK,
    RESOURCE_LANGS::LANG_GUJARATI,   RESOURCE_LANGS::LANG_HEBREW,
    RESOURCE_LANGS::LANG_HINDI,      RESOURCE_LANGS::LANG_HUNGARIAN,
    RESOURCE_LANGS::LANG_ICELANDIC,  RESOURCE_LANGS::LANG_INDONESIAN,
    RESOURCE_LANGS::LANG_ITALIAN,    RESOURCE_LANGS::LANG_JAPANESE,
    RESOURCE_LANGS::LANG_KANNADA,    RESOURCE_LANGS::LANG_KASHMIRI,
    RESOURCE_LANGS::LANG_KAZAK,      RESOURCE_LANGS::LANG_KONKANI,
    RESOURCE_LANGS::LANG_KOREAN,     RESOURCE_LANGS::LANG_KYRGYZ,
    RESOURCE_LANGS::LANG_LATVIAN,    RESOURCE_LANGS::LANG_LITHUANIAN,
    RESOURCE_LANGS::LANG_MACEDONIAN, RESOURCE_LANGS::LANG_MALAY,
    RESOURCE_LANGS::LANG_MALAYALAM,  RESOURCE_LANGS::LANG_MANIPURI,
    RESOURCE_LANGS::LANG_MARATHI,    RESOURCE_LANGS::LANG_MONGOLIAN,
    RESOURCE_LANGS::LANG_NEPALI,     RESOURCE_LANGS::LANG_NORWEGIAN,
    RESOURCE_LANGS::LANG_ORIYA,      RESOURCE_LANGS::LANG_POLISH,
    RESOURCE_LANGS::LANG_PORTUGUESE, RESOURCE_LANGS::LANG_PUNJABI,
    RESOURCE_LANGS::LANG_ROMANIAN,   RESOURCE_LANGS::LANG_RUSSIAN,
    RESOURCE_LANGS::LANG_SANSKRIT,   RESOURCE_LANGS::LANG_SERBIAN,
    RESOURCE_LANGS::LANG_SINDHI,     RESOURCE_LANGS::LANG_SLOVAK,
    RESOURCE_LANGS::LANG_SLOVENIAN,  RESOURCE_LANGS::LANG_SPANISH,
    RESOURCE_LANGS::LANG_SWAHILI,    RESOURCE_LANGS::LANG_SWEDISH,
    RESOURCE_LANGS::LANG_SYRIAC,     RESOURCE_LANGS::LANG_TAMIL,
    RESOURCE_LANGS::LANG_TATAR,      RESOURCE_LANGS::LANG_TELUGU,
    RESOURCE_LANGS::LANG_THAI,       RESOURCE_LANGS::LANG_TURKISH,
    RESOURCE_LANGS::LANG_UKRAINIAN,  RESOURCE_LANGS::LANG_URDU,
    RESOURCE_LANGS::LANG_UZBEK,      RESOURCE_LANGS::LANG_VIETNAMESE,
    RESOURCE_LANGS::LANG_GAELIC,     RESOURCE_LANGS::LANG_MALTESE,
    RESOURCE_LANGS::LANG_MAORI,      RESOURCE_LANGS::LANG_RHAETO_ROMANCE,
    RESOURCE_LANGS::LANG_SAMI,       RESOURCE_LANGS::LANG_SORBIAN,
    RESOURCE_LANGS::LANG_SUTU,       RESOURCE_LANGS::LANG_TSONGA,
    RESOURCE_LANGS::LANG_TSWANA,     RESOURCE_LANGS::LANG_VENDA,
    RESOURCE_LANGS::LANG_XHOSA,      RESOURCE_LANGS::LANG_ZULU,
    RESOURCE_LANGS::LANG_ESPERANTO,  RESOURCE_LANGS::LANG_WALON,
    RESOURCE_LANGS::LANG_CORNISH,    RESOURCE_LANGS::LANG_WELSH,
    RESOURCE_LANGS::LANG_BRETON,     RESOURCE_LANGS::LANG_INUKTITUT,
    RESOURCE_LANGS::LANG_IRISH,      RESOURCE_LANGS::LANG_LOWER_SORBIAN,
    RESOURCE_LANGS::LANG_PULAR,      RESOURCE_LANGS::LANG_QUECHUA,
    RESOURCE_LANGS::LANG_TAMAZIGHT,  RESOURCE_LANGS::LANG_TIGRINYA,
