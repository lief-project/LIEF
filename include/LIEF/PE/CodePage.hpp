...
enum class CODE_PAGES : uint32_t {
  ...
  IBM870 = 870,   /**< IBM EBCDIC Multilingual/ROECE (Latin 2); IBM EBCDIC
  ...
  GB2312 = 936,         /**< ANSI/OEM Simplified Chinese (PRC, Singapore); Chinese
                           Simplified (GB2312) */
  ...
  IBM01140 = 1140, /**< IBM EBCDIC US-Canada (037 + Euro symbol); IBM EBCDIC
                      (US-Canada-Euro) */
  IBM01141 = 1141, /**< IBM EBCDIC Germany (20273 + Euro symbol); IBM EBCDIC
                      (Germany-Euro) */
  IBM01142 = 1142, /**< IBM EBCDIC Denmark-Norway (20277 + Euro symbol); IBM EBCDIC
                      (Denmark-Norway-Euro) */
  IBM01143 = 1143, /**< IBM EBCDIC Finland-Sweden (20278 + Euro symbol); IBM EBCDIC
                      (Finland-Sweden-Euro) */
  IBM01144 =
      1144, /**< IBM EBCDIC Italy (20280 + Euro symbol); IBM EBCDIC (Italy-Euro) */
  IBM01145 = 1145, /**< IBM EBCDIC Latin America-Spain (20284 + Euro symbol); IBM
                      EBCDIC (Spain-Euro) */
  IBM01146 = 1146, /**< IBM EBCDIC United Kingdom (20285 + Euro symbol); IBM EBCDIC
                      (UK-Euro) */
  IBM01147 = 1147, /**< IBM EBCDIC France (20297 + Euro symbol); IBM EBCDIC
                      (France-Euro) */
  IBM01148 = 1148, /**< IBM EBCDIC International (500 + Euro symbol); IBM EBCDIC
                      (International-Euro) */
  IBM01149 = 1149, /**< IBM EBCDIC Icelandic (20871 + Euro symbol); IBM EBCDIC
                      (Icelandic-Euro) */
  UTF_16 = 1200, /**< Unicode UTF-16, little endian byte order (BMP of ISO 10646);
                    available only to managed applications */
  UNICODEFFFE = 1201, /**< Unicode UTF-16, big endian byte order; available only to
  ...
  UTF_32 = 12000, /**< Unicode UTF-32, little endian byte order; available only to
                     managed applications */
  UTF_32BE = 12001, /**< Unicode UTF-32, big endian byte order; available only to
                       managed applications */
  ...
  X_IA5 = 20105,        /**< IA5 (IRV International Alphabet No. 5, 7-bit); Western
                           European (IA5) */
  ...
  CSISO2022JP = 50221,     /**< ISO 2022 Japanese with halfwidth Katakana; Japanese
                              (JIS-Allow 1 byte Kana) */
  ISO_2022_JP_JIS = 50222, /**< ISO 2022 Japanese JIS X 0201-1989; Japanese
  ...
  GB18030 = 54936, /**< Windows XP and later: GB18030 Simplified Chinese (4 byte);
