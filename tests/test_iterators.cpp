...
using it_filter_const_ref =
    const_filter_iterator<const std::vector<std::string>&>;
using it_filter_const_ref_local =
    const_filter_iterator<std::vector<std::string>>;
using it_filter_const_ref_ptr =
    const_filter_iterator<std::vector<std::string*>>;
...
struct Foo {
  ...
  it_const_ref_t get_bar(void) const { return {this->bar}; }

  it_ref_t get_bar(void) { return {this->bar}; }
  ...
  it_ref_dummies_t get_dummies(void) { return {this->dummies_}; }

  it_const_ref_ptr_t get_bar_ptr(void) const { return {bar_ptr}; }

  it_ref_ptr_t get_bar_ptr(void) { return {bar_ptr}; }
...
TEST_CASE("Test const filter ref iterators",
  ...
  SECTION("local") {
    it_filter_const_ref_local bar_ptr_filtred =
        foo.get_bar_const_filter_local();
