...
def test_s390():
    s390 = parse_elf("ELF/elf_reader.s390.elf")
...
def test_xtensa():
    xtensa = parse_elf("ELF/elf_reader.xtensa.elf")
...
def test_mips():
    mips = parse_elf("ELF/elf_reader.mips.elf")
...
def test_riscv64():
    riscv64 = parse_elf("ELF/elf_reader.riscv64.elf")
...
def test_riscv32():
    riscv32 = parse_elf("ELF/elf_reader.riscv32.elf")
...
def test_ppc64le():
    ppc64le = parse_elf("ELF/elf_reader.ppc64le.elf")
...
def test_hexagon():
    hexagon = parse_elf("ELF/modem.hexagon.elf")
