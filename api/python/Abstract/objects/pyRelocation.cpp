...
void create<Relocation>(py::module& m) {
  py::class_<Relocation, Object>(m, "Relocation",
      ...
      .def(py::init<uint64_t, uint8_t>(),
           "Constructor from an :attr:`~lief.Relocation.address` and a "
           ":attr:`~lief.Relocation.size`",
           "address"_a, "size"_a)
      ...
      .def_property("size", static_cast<getter_t<size_t>>(&Relocation::size),
      ...
      .def("__str__", [](const Relocation& entry) {
