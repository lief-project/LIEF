...
void create<File>(py::module& m) {
  ...
  file.def_property_readonly("version", &File::version, "Dex version")

      .def_property_readonly(
          "header", static_cast<no_const_getter_t<Header&>>(&File::header),
      ...
      .def("get_class",
           ...
           "classname"_a, py::return_value_policy::reference)

      .def("get_class", static_cast<Class* (File::*)(size_t)>(&File::get_class),
           "classname"_a, py::return_value_policy::reference)
      ...
      .def_property_readonly(
          "types", static_cast<no_const_getter_t<File::it_types>>(&File::types),
          "Iterator over Dex " RST_CLASS_REF(lief.DEX.Type) "")

      .def_property_readonly(
          "prototypes",
          static_cast<no_const_getter_t<File::it_prototypes>>(
              &File::prototypes),
          "Iterator over Dex " RST_CLASS_REF(lief.DEX.Prototype) "")

      .def_property_readonly(
          "map", static_cast<no_const_getter_t<MapList&>>(&File::map),
          "Dex " RST_CLASS_REF(lief.DEX.MapList) "")

      .def("raw", &File::raw, "Original raw file", "deoptimize"_a = true)
      ...
      .def_property_readonly("dex2dex_json_info", &File::dex2dex_json_info)
