...
class Binary(lief.Binary):
    ...
    @property
    def resources_manager(self) -> lief.PE.ResourcesManager | lief.lief_errors: ...
    @property
...
class LoadConfiguration(lief.Object):
    ...
    def size(self) -> int: ...
    @property
    def version(self) -> lief.PE.WIN_VERSION: ...
...
@overload
def parse(obj: io.IOBase | os.PathLike, config: lief.PE.ParserConfig = ...) -> lief.PE.Binary | None: ...
