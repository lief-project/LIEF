...
class DATA_DIRECTORY:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.DATA_DIRECTORY: ...
    @property
    def value(self) -> int: ...
...
class DLL_CHARACTERISTICS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.DLL_CHARACTERISTICS: ...
    def __abs__(self) -> Any: ...
    def __add__(self, other) -> Any: ...
    def __floordiv__(self, other) -> Any: ...
    def __lshift__(self, other) -> Any: ...
...
class HEADER_CHARACTERISTICS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.HEADER_CHARACTERISTICS: ...
    def __abs__(self) -> Any: ...
    def __add__(self, other) -> Any: ...
    def __floordiv__(self, other) -> Any: ...
    def __lshift__(self, other) -> Any: ...
...
class MACHINE_TYPES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.MACHINE_TYPES: ...
    @property
    def value(self) -> int: ...
...
class OptionalHeader(lief.Object):
    ...
    def __contains__(self, arg: lief.PE.DLL_CHARACTERISTICS, /) -> bool: ...
    def __iadd__(self, arg: lief.PE.DLL_CHARACTERISTICS, /) -> lief.PE.OptionalHeader: ...
    def __isub__(self, arg: lief.PE.DLL_CHARACTERISTICS, /) -> lief.PE.OptionalHeader: ...
    @property
...
class SUBSYSTEM:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.SUBSYSTEM: ...
    @property
    def value(self) -> int: ...
