...
class Binary(lief.Binary):
    ...
    class it_debug:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg: int, /) -> lief.PE.Debug | lief.PE.CodeView | lief.PE.CodeViewPDB | lief.PE.Pogo | lief.PE.Repro : ...
        def __iter__(self) -> lief.PE.Binary.it_debug: ...
        def __len__(self) -> int: ...
        def __next__(self) -> lief.PE.Debug | lief.PE.CodeView | lief.PE.CodeViewPDB | lief.PE.Pogo | lief.PE.Repro : ...
    ...
    def data_directory(self, type: lief.PE.TYPES) -> lief.PE.DataDirectory: ...
    ...
    @property
    def resources_manager(self) -> lief.PE.ResourcesManager | None: ...
    @property
...
class GUARD_CF_FLAGS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.GUARD_CF_FLAGS: ...
    def __abs__(self) -> Any: ...
    def __add__(self, other) -> Any: ...
    def __floordiv__(self, other) -> Any: ...
    def __lshift__(self, other) -> Any: ...
...
class LoadConfigurationV1(LoadConfigurationV0):
    ...
    def __contains__(self, arg: lief.PE.GUARD_CF_FLAGS, /) -> bool: ...
    @property
...
class RESOURCE_SUBLANGS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.RESOURCE_SUBLANGS: ...
    @property
    def value(self) -> int: ...
...
class RESOURCE_TYPES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.RESOURCE_TYPES: ...
    @property
    def value(self) -> int: ...
...
class ResourceData(ResourceNode):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, content, std, code_page: int) -> None: ...
    @property
    def offset(self) -> int: ...
...
class ResourceNode(lief.Object):
    ...
    def copy(self) -> lief.PE.ResourceNode: ...
    @overload
...
class SECTION_CHARACTERISTICS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.SECTION_CHARACTERISTICS: ...
    def __abs__(self) -> Any: ...
    def __add__(self, other) -> Any: ...
    def __floordiv__(self, other) -> Any: ...
    def __lshift__(self, other) -> Any: ...
...
class Section(lief.Section):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, content, std, name: str = ..., characteristics: int = ...) -> None: ...
    @overload
...
class Signature(lief.Object):
    ...
    @overload
    @staticmethod
    def parse(path: str) -> lief.PE.Binary | None: ...
    @overload
    @staticmethod
    def parse(raw: list[int], skip_header: bool = ...) -> lief.PE.Binary | None: ...
    @property
...
class TYPES:
    ARCHITECTURE: ClassVar[TYPES] = ...
    BASE_RELOCATION_TABLE: ClassVar[TYPES] = ...
    BOUND_IMPORT: ClassVar[TYPES] = ...
    CERTIFICATE_TABLE: ClassVar[TYPES] = ...
    CLR_RUNTIME_HEADER: ClassVar[TYPES] = ...
    DEBUG: ClassVar[TYPES] = ...
    DELAY_IMPORT_DESCRIPTOR: ClassVar[TYPES] = ...
    EXCEPTION_TABLE: ClassVar[TYPES] = ...
    EXPORT_TABLE: ClassVar[TYPES] = ...
    GLOBAL_PTR: ClassVar[TYPES] = ...
    IAT: ClassVar[TYPES] = ...
    IMPORT_TABLE: ClassVar[TYPES] = ...
    LOAD_CONFIG_TABLE: ClassVar[TYPES] = ...
    RESERVED: ClassVar[TYPES] = ...
    RESOURCE_TABLE: ClassVar[TYPES] = ...
    TLS_TABLE: ClassVar[TYPES] = ...
    UNKNOWN: ClassVar[TYPES] = ...
    __name__: Any
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.TYPES: ...
    @property
    def value(self) -> int: ...
...
class WIN_VERSION:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.PE.WIN_VERSION: ...
    @property
    def value(self) -> int: ...
...
class x509(lief.Object):
    ...
    @overload
    @staticmethod
    def parse(raw: list[int]) -> lief.PE.Binary | None: ...
    @overload
...
@overload
def parse(filename: str, config: lief.PE.ParserConfig = ...) -> lief.PE.Binary | None: ...
@overload
def parse(raw: list[int], config: lief.PE.ParserConfig = ...) -> lief.PE.Binary | None: ...
@overload
def parse(io: object, config: lief.PE.ParserConfig = ...) -> lief.PE.Binary | None: ...
