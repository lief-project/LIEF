...
class DyldSharedCache:
    ...
    class VERSION:
        ...
        def __lt__(self, other) -> bool: ...
    def __init__(self, *args, **kwargs) -> None: ...
    def cache_for_address(self, address: int) -> Optional[lief.dsc.DyldSharedCache]: ...
    ...
    def find_subcache(self, filename: str) -> Optional[lief.dsc.DyldSharedCache]: ...
    ...
    @property
    def main_cache(self) -> Optional[lief.dsc.DyldSharedCache]: ...
    @property
