...
@overload
def parse(raw: List[int], dynsym_count_method: lief.ELF.DYNSYM_COUNT_METHODS = ...) -> lief.ELF.Binary | None: ...
@overload
def parse(io: object, dynsym_count_method: lief.ELF.DYNSYM_COUNT_METHODS = ...) -> lief.ELF.Binary | None: ...
