...
import lief.MachO.DyldExportsTrie # type: ignore
...
class Binary(lief.Binary):
    ...
    @property
    def bindings(self) -> Iterator[lief.MachO.BindingInfo]: ...
    @property
    ...
    @property
    def platform(self) -> lief.MachO.BuildVersion.PLATFORMS: ...
    @property
...
class BuildToolVersion(lief.Object):
    class TOOLS:
        ...
        LLD: ClassVar[BuildToolVersion.TOOLS] = ...
...
class BuildVersion(LoadCommand):
    class PLATFORMS:
        ANY: ClassVar[BuildVersion.PLATFORMS] = ...
        BRIDGEOS: ClassVar[BuildVersion.PLATFORMS] = ...
        DRIVERKIT: ClassVar[BuildVersion.PLATFORMS] = ...
        FIRMWARE: ClassVar[BuildVersion.PLATFORMS] = ...
        IOS: ClassVar[BuildVersion.PLATFORMS] = ...
        IOS_SIMULATOR: ClassVar[BuildVersion.PLATFORMS] = ...
        MACOS: ClassVar[BuildVersion.PLATFORMS] = ...
        MAC_CATALYST: ClassVar[BuildVersion.PLATFORMS] = ...
        SEPOS: ClassVar[BuildVersion.PLATFORMS] = ...
        TVOS: ClassVar[BuildVersion.PLATFORMS] = ...
        TVOS_SIMULATOR: ClassVar[BuildVersion.PLATFORMS] = ...
        UNKNOWN: ClassVar[BuildVersion.PLATFORMS] = ...
        VISIONOS: ClassVar[BuildVersion.PLATFORMS] = ...
        VISIONOS_SIMULATOR: ClassVar[BuildVersion.PLATFORMS] = ...
        WATCHOS: ClassVar[BuildVersion.PLATFORMS] = ...
        WATCHOS_SIMULATOR: ClassVar[BuildVersion.PLATFORMS] = ...
        __name__: str
        def __init__(self, *args, **kwargs) -> None: ...
        @staticmethod
...
class ChainedPointerAnalysis:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(ptr: int, size: int) -> Optional[lief.MachO.ChainedPointerAnalysis]: ...
    def get_as(self, arg: lief.MachO.DYLD_CHAINED_PTR_FORMAT, /) -> Union[lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_rebase_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_bind_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_auth_rebase_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_auth_bind_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_64_rebase_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_bind24_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_auth_bind24_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_64_bind_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_64_kernel_cache_rebase_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_32_rebase_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_32_bind_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_32_cache_rebase_t,lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_32_firmware_rebase_t,int,None]: ...
    @staticmethod
    def stride(fmt: lief.MachO.DYLD_CHAINED_PTR_FORMAT) -> int: ...
    @property
    def dyld_chained_ptr_32_bind(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_32_bind_t: ...
    @property
    def dyld_chained_ptr_32_cache_rebase(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_32_cache_rebase_t: ...
    @property
    def dyld_chained_ptr_32_firmware_rebase(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_32_firmware_rebase_t: ...
    @property
    def dyld_chained_ptr_32_rebase(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_32_rebase_t: ...
    @property
    def dyld_chained_ptr_64_bind(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_64_bind_t: ...
    @property
    def dyld_chained_ptr_64_kernel_cache_rebase(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_64_kernel_cache_rebase_t: ...
    @property
    def dyld_chained_ptr_64_rebase(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_64_rebase_t: ...
    @property
    def dyld_chained_ptr_arm64e_auth_bind(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_auth_bind_t: ...
    @property
    def dyld_chained_ptr_arm64e_auth_bind24(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_auth_bind24_t: ...
    @property
    def dyld_chained_ptr_arm64e_auth_rebase(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_auth_rebase_t: ...
    @property
    def dyld_chained_ptr_arm64e_bind(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_bind_t: ...
    @property
    def dyld_chained_ptr_arm64e_bind24(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_bind24_t: ...
    @property
    def dyld_chained_ptr_arm64e_rebase(self) -> lief.MachO.ChainedPointerAnalysis.dyld_chained_ptr_arm64e_rebase_t: ...
    @property
    def size(self) -> int: ...
    @property
    def value(self) -> int: ...
...
class DYLD_CHAINED_PTR_FORMAT:
    NONE: ClassVar[DYLD_CHAINED_PTR_FORMAT] = ...
...
class DyldExportsTrie(LoadCommand):
    class it_export_info:
        ...
        def __iter__(self) -> lief.MachO.DyldExportsTrie.it_export_info: ...
        def __len__(self) -> int: ...
    ...
    def content(self) -> memoryview: ...
    @property
    def exports(self) -> lief.MachO.DyldExportsTrie.it_export_info: ...
...
class Section(lief.Section):
    ...
    class it_relocations:
        def __init__(self, *args, **kwargs) -> None: ...
        def __getitem__(self, arg: int, /) -> lief.MachO.Relocation: ...
        def __iter__(self) -> lief.MachO.Section.it_relocations: ...
        def __len__(self) -> int: ...
        def __next__(self) -> lief.MachO.Relocation: ...
    alignment: int
