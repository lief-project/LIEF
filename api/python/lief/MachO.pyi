...
class Builder:
    ...
    @overload
    @staticmethod
    def write(binary: lief.MachO.Binary, output: str) -> object: ...
    @overload
    @staticmethod
    def write(binary: lief.MachO.Binary, output: str, config: lief.MachO.Builder.config_t) -> object: ...
    @overload
    @staticmethod
    def write(fat_binary: lief.MachO.FatBinary, output: str) -> object: ...
    @overload
    @staticmethod
    def write(fat_binary: lief.MachO.FatBinary, output: str, config: lief.MachO.Builder.config_t) -> object: ...
...
@overload
def parse(raw: list[int], config: lief.MachO.ParserConfig = ...) -> lief.MachO.Binary | None: ...
@overload
def parse(io: object, config: lief.MachO.ParserConfig = ...) -> lief.MachO.Binary | None: ...
