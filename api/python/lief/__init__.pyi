...
class VectorStream(BinaryStream):
    @staticmethod
    def from_file(arg: Union[str, os.PathLike], /) -> Union[VectorStream,lief.lief_errors]: ...
...
class Binary(Object):
    ...
    @overload
    def patch_address(self, address: int, patch_value: str, addr_type: VA_TYPES = ...) -> None: ...

    @overload
    def patch_address(self, address: int, patch_value: str, expected_value: str, addr_type: VA_TYPES = ...) -> None: ...
...
class Section(Object):
    ...
    @overload
    def search(self, bytes: Union[bytearray, memoryview], pos: int = 0) -> Optional[int]: ...

    def search_string(self, str: str, pos: int = 0) -> Optional[int]: ...
    ...
    @overload
    def search_all(self, bytes: bytes, size: int = 0) -> list[int]: ...

    @overload
    def search_all(self, buffer: Union[bytearray, memoryview], size: int = 0) -> list[int]: ...

    @overload
    def search_all(self, str: str) -> list[int]: ...

    def search_string_all(self, str: str) -> list[int]: ...
