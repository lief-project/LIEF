...
class CompilationUnit:
    class Language:
        class LANG:
            ...
            COBOL: ClassVar[CompilationUnit.Language.LANG] = ...
            CPP: ClassVar[CompilationUnit.Language.LANG] = ...
            D: ClassVar[CompilationUnit.Language.LANG] = ...
            DART: ClassVar[CompilationUnit.Language.LANG] = ...
            FORTRAN: ClassVar[CompilationUnit.Language.LANG] = ...
            JAVA: ClassVar[CompilationUnit.Language.LANG] = ...
            MODULA: ClassVar[CompilationUnit.Language.LANG] = ...
            RUST: ClassVar[CompilationUnit.Language.LANG] = ...
            SWIFT: ClassVar[CompilationUnit.Language.LANG] = ...
    ...
    @property
    def imported_functions(self) -> Iterator[Optional[lief.dwarf.Function]]: ...
    @property
...
class Function:
    ...
    def size(self) -> int: ...
    @property
    def thrown_types(self) -> list[Optional[lief.dwarf.Type]]: ...
    @property
...
class Type:
    class KIND:
        ...
        ATOMIC: ClassVar[Type.KIND] = ...
        BASE: ClassVar[Type.KIND] = ...
        CLASS: ClassVar[Type.KIND] = ...
        COARRAY: ClassVar[Type.KIND] = ...
        CONST_KIND: ClassVar[Type.KIND] = ...
        DYNAMIC: ClassVar[Type.KIND] = ...
        ENUM: ClassVar[Type.KIND] = ...
        FILE: ClassVar[Type.KIND] = ...
        IMMUTABLE: ClassVar[Type.KIND] = ...
        INTERFACE: ClassVar[Type.KIND] = ...
        PACKED: ClassVar[Type.KIND] = ...
        POINTER: ClassVar[Type.KIND] = ...
        POINTER_MEMBER: ClassVar[Type.KIND] = ...
        REF: ClassVar[Type.KIND] = ...
        RESTRICT: ClassVar[Type.KIND] = ...
        RVALREF: ClassVar[Type.KIND] = ...
        SET_TYPE: ClassVar[Type.KIND] = ...
        SHARED: ClassVar[Type.KIND] = ...
        STRING: ClassVar[Type.KIND] = ...
        STRUCT: ClassVar[Type.KIND] = ...
        SUBROUTINE: ClassVar[Type.KIND] = ...
        TEMPLATE_ALIAS: ClassVar[Type.KIND] = ...
        THROWN: ClassVar[Type.KIND] = ...
        TYPEDEF: ClassVar[Type.KIND] = ...
        UNION: ClassVar[Type.KIND] = ...
        UNKNOWN: ClassVar[Type.KIND] = ...
        UNSPECIFIED: ClassVar[Type.KIND] = ...
        VOLATILE: ClassVar[Type.KIND] = ...
        __name__: str
        def __init__(self, *args, **kwargs) -> None: ...
        def __ge__(self, other) -> bool: ...
        def __gt__(self, other) -> bool: ...
