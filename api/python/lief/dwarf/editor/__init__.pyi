...
class EnumType(Type):
    ...
    def set_underlying_type(self, type: Type) -> EnumType: ...
...
class Function:
    ...
    class LexicalBlock:
        @overload
        def add_block(self, start: int, end: int) -> Optional[Function.LexicalBlock]: ...

        @overload
        def add_block(self, range: Sequence[Function.range_t]) -> Optional[Function.LexicalBlock]: ...

        def add_description(self, description: str) -> Function.LexicalBlock: ...

        def add_name(self, name: str) -> Function.LexicalBlock: ...
...
class Variable:
    ...
    def add_description(self, description: str) -> Variable: ...
