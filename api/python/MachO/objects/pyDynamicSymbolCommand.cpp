  ...
  py::class_<DynamicSymbolCommand, LoadCommand>(m, "DynamicSymbolCommand",
      ...
      .def_property("idx_local_symbol",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::idx_local_symbol),
      ...
      .def_property("nb_local_symbols",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_local_symbols),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_local_symbols),
      ...
      .def_property(
          ...
          static_cast<getter_t<uint32_t>>(
              &DynamicSymbolCommand::idx_external_define_symbol),
          static_cast<setter_t<uint32_t>>(
              &DynamicSymbolCommand::idx_external_define_symbol),
      ...
      .def_property(
          ...
          static_cast<getter_t<uint32_t>>(
              &DynamicSymbolCommand::nb_external_define_symbols),
          static_cast<setter_t<uint32_t>>(
              &DynamicSymbolCommand::nb_external_define_symbols),
      ...
      .def_property("idx_undefined_symbol",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::idx_undefined_symbol),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::idx_undefined_symbol),
                    "Index of the first symbol in the group of undefined "
                    "external symbols.")

      .def_property(
          "nb_undefined_symbols",
          static_cast<getter_t<uint32_t>>(
              &DynamicSymbolCommand::nb_undefined_symbols),
          static_cast<setter_t<uint32_t>>(
              &DynamicSymbolCommand::nb_undefined_symbols),
      ...
      .def_property("module_table_offset",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::module_table_offset),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::module_table_offset),
                    R"delim(
      ...
      .def_property("nb_module_table",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_module_table),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_module_table),
                    R"delim(
      ...
      .def_property(
          ...
          static_cast<getter_t<uint32_t>>(
              &DynamicSymbolCommand::external_reference_symbol_offset),
          static_cast<setter_t<uint32_t>>(
              &DynamicSymbolCommand::external_reference_symbol_offset),
          R"delim(
      ...
      .def_property("nb_external_reference_symbols",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_external_reference_symbols),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_external_reference_symbols),
                    R"delim(
      ...
      .def_property("indirect_symbol_offset",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::indirect_symbol_offset),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::indirect_symbol_offset),
                    R"delim(
      ...
      .def_property("nb_indirect_symbols",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_indirect_symbols),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_indirect_symbols),
      ...
      .def_property("external_relocation_offset",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::external_relocation_offset),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::external_relocation_offset),
                    R"delim(
      Byte offset from the start of the file to the module table data.
      ...
      .def_property("nb_external_relocations",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_external_relocations),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_external_relocations),
                    R"delim(
      ...
      .def_property("local_relocation_offset",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::local_relocation_offset),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::local_relocation_offset),
                    R"delim(
      ...
      .def_property("nb_local_relocations",
                    static_cast<getter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_local_relocations),
                    static_cast<setter_t<uint32_t>>(
                        &DynamicSymbolCommand::nb_local_relocations),
                    R"delim(
      ...
      .def("__hash__",
           [](const DynamicSymbolCommand& cmd) { return Hash::hash(cmd); })

      .def("__str__", [](const DynamicSymbolCommand& info) {
