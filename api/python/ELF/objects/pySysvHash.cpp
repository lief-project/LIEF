  ...
  py::class_<SysvHash, LIEF::Object>(m, "SysvHash",
    ...
    References:
      ...
      * https://docs.oracle.com/cd/E23824_01/html/819-0690/chapter6-48031.html
      ...
      .def_property_readonly("nbucket", &SysvHash::nbucket,
      ...
      .def_property_readonly("buckets", &SysvHash::buckets, "Buckets values",
                             py::return_value_policy::reference_internal)

      .def_property_readonly("chains", &SysvHash::chains, "Chains values",
                             py::return_value_policy::reference_internal)

      .def("__eq__", &SysvHash::operator==)
      .def("__ne__", &SysvHash::operator!=)
      .def("__hash__",
           [](const SysvHash& sysvhash) { return Hash::hash(sysvhash); })

      .def("__str__", [](const SysvHash& sysvhash) {
