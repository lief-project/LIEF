...
void create<CoreSigInfo>(py::module& m) {
  py::class_<CoreSigInfo, NoteDetails>(m, "CoreSigInfo")
      ...
      .def_property(
          "signo", static_cast<getter_t<int32_t>>(&CoreSigInfo::signo),
          static_cast<setter_t<int32_t>>(&CoreSigInfo::signo), "Signal number")

      .def_property(
          "sigcode", static_cast<getter_t<int32_t>>(&CoreSigInfo::sigcode),
          static_cast<setter_t<int32_t>>(&CoreSigInfo::sigcode), "Signal code")
      ...
      .def("__hash__", [](const CoreSigInfo& note) { return Hash::hash(note); })

      .def("__str__", [](const CoreSigInfo& note) {
