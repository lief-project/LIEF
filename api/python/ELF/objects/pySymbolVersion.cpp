...
void create<SymbolVersion>(py::module& m) {
  py::class_<SymbolVersion, LIEF::Object>(m, "SymbolVersion")
      ...
      .def(py::init<uint16_t>(),
           "Constructor from :attr:`~lief.SymbolVersion.value`")

      .def_property_readonly_static(
          "local", [](const py::object&) { return SymbolVersion::local(); },
          "Generate a *local* " RST_CLASS_REF(lief.ELF.SymbolVersion) "")

      .def_property_readonly_static(
          "global_", [](const py::object&) { return SymbolVersion::global(); },
      ...
      .def_property(
          ...
          static_cast<void (SymbolVersion::*)(SymbolVersionAuxRequirement&)>(
              &SymbolVersion::symbol_version_auxiliary),
          R"delim(
      ...
      .def("__hash__", [](const SymbolVersion& sv) { return Hash::hash(sv); })

      .def("__str__", [](const SymbolVersion& symbolVersion) {
