...
void create<SymbolVersionDefinition>(py::module& m) {
  py::class_<SymbolVersionDefinition, LIEF::Object> sym_ver_def(
      m, "SymbolVersionDefinition",
      "Class which represents an entry defined in ``DT_VERDEF`` or "
      "``.gnu.version_d``");

  init_ref_iterator<SymbolVersionDefinition::it_version_aux>(sym_ver_def,
                                                             "it_version_aux");
  sym_ver_def
      .def_property(
          "version",
      ...
      .def_property_readonly(
          "auxiliary_symbols",
          static_cast<no_const_getter<SymbolVersionDefinition::it_version_aux>>(
              &SymbolVersionDefinition::symbols_aux),
          py::return_value_policy::reference_internal)

      .def("__eq__", &SymbolVersionDefinition::operator==)
      .def("__ne__", &SymbolVersionDefinition::operator!=)
      .def("__hash__",
           [](const SymbolVersionDefinition& svd) { return Hash::hash(svd); })

      .def("__str__", [](const SymbolVersionDefinition& svd) {
