...
void create<SymbolVersionRequirement>(py::module& m) {
  ...
  py::class_<SymbolVersionRequirement, LIEF::Object> sym_ver_req(
      m, "SymbolVersionRequirement",
      "Class which represents an entry in the ``DT_VERNEED`` or "
      "``.gnu.version_r`` table");

  init_ref_iterator<SymbolVersionRequirement::it_aux_requirement>(
      sym_ver_req, "it_aux_requirement");
  ...
  sym_ver_req
      ...
      .def_property("name",
                    static_cast<getter_t<const std::string&>>(
                        &SymbolVersionRequirement::name),
      ...
      .def("get_auxiliary_symbols",
           static_cast<
               no_const_getter<SymbolVersionRequirement::it_aux_requirement>>(
               &SymbolVersionRequirement::auxiliary_symbols),
           "Auxiliary entries (iterator over " RST_CLASS_REF(
               lief.ELF.SymbolVersionAuxRequirement) ")",
           py::return_value_policy::reference_internal)

      .def(
          "add_auxiliary_requirement",
          static_cast<SymbolVersionAuxRequirement& (
              SymbolVersionRequirement::*)(const SymbolVersionAuxRequirement&)>(
      ...
      .def("__hash__",
           [](const SymbolVersionRequirement& svr) { return Hash::hash(svr); })
