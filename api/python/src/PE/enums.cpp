...
void init_enums(nb::module_& m) {
  ...
  enum_<MACHINE_TYPES>(m, "MACHINE_TYPES")
  ...
  enum_<HEADER_CHARACTERISTICS>(m, "HEADER_CHARACTERISTICS", nb::is_arithmetic())
  ...
  enum_<DATA_DIRECTORY>(m, "DATA_DIRECTORY")
  ...
  enum_<DLL_CHARACTERISTICS>(m, "DLL_CHARACTERISTICS", nb::is_arithmetic())
  ...
  enum_<SECTION_CHARACTERISTICS>(m, "SECTION_CHARACTERISTICS", nb::is_arithmetic())
  ...
  enum_<DEBUG_TYPES>(m, "DEBUG_TYPES")
  ...
  enum_<RESOURCE_TYPES>(m, "RESOURCE_TYPES")
  ...
  enum_<RESOURCE_SUBLANGS>(m, "RESOURCE_SUBLANGS")
  ...
  enum_<WIN_VERSION>(m, "WIN_VERSION")
  ...
  enum_<GUARD_CF_FLAGS>(m, "GUARD_CF_FLAGS", nb::is_arithmetic())
  ...
  enum_<CODE_VIEW_SIGNATURES>(m, "CODE_VIEW_SIGNATURES")
  ...
  enum_<POGO_SIGNATURES>(m, "POGO_SIGNATURES")
