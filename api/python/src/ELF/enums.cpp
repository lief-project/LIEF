...
void init_enums(nb::module_& m) {
  ...
  enum_<ELF_SECTION_TYPES>(m, "SECTION_TYPES")
  ...
  enum_<ELF_SECTION_FLAGS>(m, "SECTION_FLAGS", nb::is_arithmetic())
  ...
  enum_<SEGMENT_TYPES>(m, "SEGMENT_TYPES")
  ...
  enum_<ELF_SEGMENT_FLAGS>(m, "SEGMENT_FLAGS", nb::is_arithmetic())
  ...
  enum_<DYNAMIC_TAGS>(m, "DYNAMIC_TAGS")
  ...
  enum_<SYMBOL_BINDINGS>(m, "SYMBOL_BINDINGS")
  ...
  enum_<RELOC_x86_64>(m, "RELOCATION_X86_64")
  ...
  enum_<RELOC_ARM>(m, "RELOCATION_ARM")
  ...
  enum_<RELOC_i386>(m, "RELOCATION_i386")
  ...
  enum_<RELOC_AARCH64>(m, "RELOCATION_AARCH64")
  ...
  enum_<RELOC_POWERPC32>(m, "RELOCATION_PPC")
  ...
  enum_<RELOC_POWERPC64>(m, "RELOCATION_PPC64")
  ...
  enum_<RELOC_MIPS>(m, "RELOCATION_MIPS")
  ...
  enum_<RELOC_LOONGARCH>(m, "RELOCATION_LOONGARCH")
  ...
  enum_<DYNSYM_COUNT_METHODS>(m, "DYNSYM_COUNT_METHODS")
  ...
  enum_<ARM_EFLAGS>(m, "ARM_EFLAGS", nb::is_arithmetic())
  ...
  enum_<PPC64_EFLAGS>(m, "PPC64_EFLAGS", nb::is_arithmetic())
    .value(PY_ENUM(PPC64_EFLAGS::EF_PPC64_ABI));

  enum_<MIPS_EFLAGS>(m, "MIPS_EFLAGS", nb::is_arithmetic())
  ...
  enum_<HEXAGON_EFLAGS>(m, "HEXAGON_EFLAGS", nb::is_arithmetic())
  ...
  enum_<LOONGARCH_EFLAGS>(m, "LOONGARCH_EFLAGS", nb::is_arithmetic())
  ...
  enum_<SYMBOL_SECTION_INDEX>(m, "SYMBOL_SECTION_INDEX")
  ...
  enum_<DYNAMIC_FLAGS>(m, "DYNAMIC_FLAGS", nb::is_arithmetic())
  ...
  enum_<DYNAMIC_FLAGS_1>(m, "DYNAMIC_FLAGS_1", nb::is_arithmetic())
  ...
  enum_<ELF_SYMBOL_VISIBILITY>(m, "SYMBOL_VISIBILITY")
