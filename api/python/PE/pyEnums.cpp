...
void init_enums(py::module& m) {
  ...
  LIEF::enum_<HEADER_CHARACTERISTICS>(m, "HEADER_CHARACTERISTICS",
                                      py::arithmetic())
      ...
      .value(
          PY_ENUM(HEADER_CHARACTERISTICS::IMAGE_FILE_REMOVABLE_RUN_FROM_SWAP))
  ...
  LIEF::enum_<DLL_CHARACTERISTICS>(m, "DLL_CHARACTERISTICS", py::arithmetic())
      ...
      .value(
          PY_ENUM(DLL_CHARACTERISTICS::IMAGE_DLL_CHARACTERISTICS_DYNAMIC_BASE))
      .value(PY_ENUM(
      ...
      .value(
          PY_ENUM(DLL_CHARACTERISTICS::IMAGE_DLL_CHARACTERISTICS_NO_ISOLATION))
      ...
      .value(
          PY_ENUM(DLL_CHARACTERISTICS::IMAGE_DLL_CHARACTERISTICS_APPCONTAINER))
      ...
      .value(PY_ENUM(DLL_CHARACTERISTICS::
                         IMAGE_DLL_CHARACTERISTICS_TERMINAL_SERVER_AWARE));

  LIEF::enum_<SECTION_CHARACTERISTICS>(m, "SECTION_CHARACTERISTICS",
                                       py::arithmetic())
  ...
  LIEF::enum_<RESOURCE_SUBLANGS>(m, "RESOURCE_SUBLANGS")
      ...
      .value(
          PY_ENUM(RESOURCE_SUBLANGS::SUBLANG_CROATIAN_BOSNIA_HERZEGOVINA_LATIN))
      ...
      .value(
          PY_ENUM(RESOURCE_SUBLANGS::SUBLANG_SERBIAN_BOSNIA_HERZEGOVINA_LATIN))
  ...
  LIEF::enum_<ACCELERATOR_VK_CODES>(m, "ACCELERATOR_VK_CODES")
      ...
      .value("VK_LAUNCH_MEDIA_SELECT",
             ACCELERATOR_VK_CODES::VK_LAUNCH_MEDIA_SELECT)
