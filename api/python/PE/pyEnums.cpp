...
void init_enums(py::module& m) {
  ...
  LIEF::enum_<LIEF::PE::GUARD_CF_FLAGS>(m, "GUARD_CF_FLAGS", py::arithmetic())
    ...
    .value(PY_ENUM(LIEF::PE::GUARD_CF_FLAGS::GRF_INSTRUMENTED))
    .value(PY_ENUM(LIEF::PE::GUARD_CF_FLAGS::GRF_ENABLE))
    .value(PY_ENUM(LIEF::PE::GUARD_CF_FLAGS::GRF_STRICT));
  ...
  LIEF::enum_<LIEF::PE::ACCELERATOR_FLAGS>(m, "ACCELERATOR_FLAGS", py::arithmetic())
    .value(PY_ENUM(LIEF::PE::ACCELERATOR_FLAGS::FVIRTKEY))
    .value(PY_ENUM(LIEF::PE::ACCELERATOR_FLAGS::FNOINVERT))
    .value(PY_ENUM(LIEF::PE::ACCELERATOR_FLAGS::FSHIFT))
    .value(PY_ENUM(LIEF::PE::ACCELERATOR_FLAGS::FCONTROL))
    .value(PY_ENUM(LIEF::PE::ACCELERATOR_FLAGS::FALT))
    .value(PY_ENUM(LIEF::PE::ACCELERATOR_FLAGS::END));

  LIEF::enum_<LIEF::PE::ACCELERATOR_VK_CODES>(m, "ACCELERATOR_VK_CODES")
    .value("VK_LBUTTON"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_LBUTTON)
    .value("VK_RBUTTON"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_RBUTTON)
    .value("VK_CANCEL"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_CANCEL)
    .value("VK_MBUTTON"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_MBUTTON)
    .value("VK_XBUTTON1"            , LIEF::PE::ACCELERATOR_VK_CODES::VK_XBUTTON1)
    .value("VK_XBUTTON2"            , LIEF::PE::ACCELERATOR_VK_CODES::VK_XBUTTON2)
    .value("VK_BACK"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_BACK)
    .value("VK_TAB"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_TAB)
    .value("VK_CLEAR"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_CLEAR)
    .value("VK_RETURN"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_RETURN)
    .value("VK_SHIFT"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_SHIFT)
    .value("VK_CONTROL"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_CONTROL)
    .value("VK_MENU"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_MENU)
    .value("VK_PAUSE"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_PAUSE)
    .value("VK_CAPITAL"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_CAPITAL)
    .value("VK_KANA"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_KANA)
    .value("VK_HANGUEL"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_HANGUEL)
    .value("VK_HANGUL"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_HANGUL)
    .value("VK_IME_ON"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_IME_ON)
    .value("VK_JUNJA"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_JUNJA)
    .value("VK_FINAL"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_FINAL)
    .value("VK_HANJA"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_HANJA)
    .value("VK_KANJI"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_KANJI)
    .value("VK_IME_OFF"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_IME_OFF)
    .value("VK_ESCAPE"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_ESCAPE)
    .value("VK_CONVERT"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_CONVERT)
    .value("VK_NONCONVERT"          , LIEF::PE::ACCELERATOR_VK_CODES::VK_NONCONVERT)
    .value("VK_ACCEPT"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_ACCEPT)
    .value("VK_MODECHANGE"          , LIEF::PE::ACCELERATOR_VK_CODES::VK_MODECHANGE)
    .value("VK_SPACE"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_SPACE)
    .value("VK_PRIOR"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_PRIOR)
    .value("VK_NEXT"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_NEXT)
    .value("VK_END"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_END)
    .value("VK_HOME"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_HOME)
    .value("VK_LEFT"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_LEFT)
    .value("VK_UP"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_UP)
    .value("VK_RIGHT"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_RIGHT)
    .value("VK_DOWN"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_DOWN)
    .value("VK_SELECT"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_SELECT)
    .value("VK_PRINT"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_PRINT)
    .value("VK_EXECUTE"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_EXECUTE)
    .value("VK_SNAPSHOT"            , LIEF::PE::ACCELERATOR_VK_CODES::VK_SNAPSHOT)
    .value("VK_INSERT"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_INSERT)
    .value("VK_DELETE"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_DELETE)
    .value("VK_HELP"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_HELP)
    .value("VK_0"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_0)
    .value("VK_1"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_1)
    .value("VK_2"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_2)
    .value("VK_3"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_3)
    .value("VK_4"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_4)
    .value("VK_5"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_5)
    .value("VK_6"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_6)
    .value("VK_7"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_7)
    .value("VK_8"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_8)
    .value("VK_9"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_9)
    .value("VK_A"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_A)
    .value("VK_B"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_B)
    .value("VK_C"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_C)
    .value("VK_D"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_D)
    .value("VK_E"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_E)
    .value("VK_F"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_F)
    .value("VK_G"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_G)
    .value("VK_H"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_H)
    .value("VK_I"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_I)
    .value("VK_J"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_J)
    .value("VK_K"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_K)
    .value("VK_L"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_L)
    .value("VK_M"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_M)
    .value("VK_N"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_N)
    .value("VK_O"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_O)
    .value("VK_P"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_P)
    .value("VK_Q"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_Q)
    .value("VK_R"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_R)
    .value("VK_S"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_S)
    .value("VK_T"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_T)
    .value("VK_U"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_U)
    .value("VK_V"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_V)
    .value("VK_W"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_W)
    .value("VK_X"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_X)
    .value("VK_Y"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_Y)
    .value("VK_Z"                   , LIEF::PE::ACCELERATOR_VK_CODES::VK_Z)
    .value("VK_LWIN"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_LWIN)
    .value("VK_RWIN"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_RWIN)
    .value("VK_APPS"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_APPS)
    .value("VK_SLEEP"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_SLEEP)
    .value("VK_NUMPAD0"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD0)
    .value("VK_NUMPAD1"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD1)
    .value("VK_NUMPAD2"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD2)
    .value("VK_NUMPAD3"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD3)
    .value("VK_NUMPAD4"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD4)
    .value("VK_NUMPAD5"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD5)
    .value("VK_NUMPAD6"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD6)
    .value("VK_NUMPAD7"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD7)
    .value("VK_NUMPAD8"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD8)
    .value("VK_NUMPAD9"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMPAD9)
    .value("VK_MULTIPLY"            , LIEF::PE::ACCELERATOR_VK_CODES::VK_MULTIPLY)
    .value("VK_ADD"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_ADD)
    .value("VK_SEPARATOR"           , LIEF::PE::ACCELERATOR_VK_CODES::VK_SEPARATOR)
    .value("VK_SUBTRACT"            , LIEF::PE::ACCELERATOR_VK_CODES::VK_SUBTRACT)
    .value("VK_DECIMAL"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_DECIMAL)
    .value("VK_DIVIDE"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_DIVIDE)
    .value("VK_F1"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F1)
    .value("VK_F2"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F2)
    .value("VK_F3"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F3)
    .value("VK_F4"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F4)
    .value("VK_F5"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F5)
    .value("VK_F6"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F6)
    .value("VK_F7"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F7)
    .value("VK_F8"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F8)
    .value("VK_F9"                  , LIEF::PE::ACCELERATOR_VK_CODES::VK_F9)
    .value("VK_F10"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F10)
    .value("VK_F11"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F11)
    .value("VK_F12"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F12)
    .value("VK_F13"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F13)
    .value("VK_F14"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F14)
    .value("VK_F15"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F15)
    .value("VK_F16"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F16)
    .value("VK_F17"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F17)
    .value("VK_F18"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F18)
    .value("VK_F19"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F19)
    .value("VK_F20"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F20)
    .value("VK_F21"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F21)
    .value("VK_F22"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F22)
    .value("VK_F23"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F23)
    .value("VK_F24"                 , LIEF::PE::ACCELERATOR_VK_CODES::VK_F24)
    .value("VK_NUMLOCK"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_NUMLOCK)
    .value("VK_SCROLL"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_SCROLL)
    .value("VK_LSHIFT"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_LSHIFT)
    .value("VK_RSHIFT"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_RSHIFT)
    .value("VK_LCONTROL"            , LIEF::PE::ACCELERATOR_VK_CODES::VK_LCONTROL)
    .value("VK_RCONTROL"            , LIEF::PE::ACCELERATOR_VK_CODES::VK_RCONTROL)
    .value("VK_LMENU"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_LMENU)
    .value("VK_RMENU"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_RMENU)
    .value("VK_BROWSER_BACK"        , LIEF::PE::ACCELERATOR_VK_CODES::VK_BROWSER_BACK)
    .value("VK_BROWSER_FORWARD"     , LIEF::PE::ACCELERATOR_VK_CODES::VK_BROWSER_FORWARD)
    .value("VK_BROWSER_REFRESH"     , LIEF::PE::ACCELERATOR_VK_CODES::VK_BROWSER_REFRESH)
    .value("VK_BROWSER_STOP"        , LIEF::PE::ACCELERATOR_VK_CODES::VK_BROWSER_STOP)
    .value("VK_BROWSER_SEARCH"      , LIEF::PE::ACCELERATOR_VK_CODES::VK_BROWSER_SEARCH)
    .value("VK_BROWSER_FAVORITES"   , LIEF::PE::ACCELERATOR_VK_CODES::VK_BROWSER_FAVORITES)
    .value("VK_BROWSER_HOME"        , LIEF::PE::ACCELERATOR_VK_CODES::VK_BROWSER_HOME)
    .value("VK_VOLUME_MUTE"         , LIEF::PE::ACCELERATOR_VK_CODES::VK_VOLUME_MUTE)
    .value("VK_VOLUME_DOWN"         , LIEF::PE::ACCELERATOR_VK_CODES::VK_VOLUME_DOWN)
    .value("VK_VOLUME_UP"           , LIEF::PE::ACCELERATOR_VK_CODES::VK_VOLUME_UP)
    .value("VK_MEDIA_NEXT_TRACK"    , LIEF::PE::ACCELERATOR_VK_CODES::VK_MEDIA_NEXT_TRACK)
    .value("VK_MEDIA_PREV_TRACK"    , LIEF::PE::ACCELERATOR_VK_CODES::VK_MEDIA_PREV_TRACK)
    .value("VK_MEDIA_STOP"          , LIEF::PE::ACCELERATOR_VK_CODES::VK_MEDIA_STOP)
    .value("VK_MEDIA_PLAY_PAUSE"    , LIEF::PE::ACCELERATOR_VK_CODES::VK_MEDIA_PLAY_PAUSE)
    .value("VK_LAUNCH_MAIL"         , LIEF::PE::ACCELERATOR_VK_CODES::VK_LAUNCH_MAIL)
    .value("VK_LAUNCH_MEDIA_SELECT" , LIEF::PE::ACCELERATOR_VK_CODES::VK_LAUNCH_MEDIA_SELECT)
    .value("VK_LAUNCH_APP1"         , LIEF::PE::ACCELERATOR_VK_CODES::VK_LAUNCH_APP1)
    .value("VK_LAUNCH_APP2"         , LIEF::PE::ACCELERATOR_VK_CODES::VK_LAUNCH_APP2)
    .value("VK_OEM_1"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_1)
    .value("VK_OEM_PLUS"            , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_PLUS)
    .value("VK_OEM_COMMA"           , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_COMMA)
    .value("VK_OEM_MINUS"           , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_MINUS)
    .value("VK_OEM_PERIOD"          , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_PERIOD)
    .value("VK_OEM_2"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_2)
    .value("VK_OEM_4"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_4)
    .value("VK_OEM_5"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_5)
    .value("VK_OEM_6"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_6)
    .value("VK_OEM_7"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_7)
    .value("VK_OEM_8"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_8)
    .value("VK_OEM_102"             , LIEF::PE::ACCELERATOR_VK_CODES::VK_OEM_102)
    .value("VK_PROCESSKEY"          , LIEF::PE::ACCELERATOR_VK_CODES::VK_PROCESSKEY)
    .value("VK_PACKET"              , LIEF::PE::ACCELERATOR_VK_CODES::VK_PACKET)
    .value("VK_ATTN"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_ATTN)
    .value("VK_CRSEL"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_CRSEL)
    .value("VK_EXSEL"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_EXSEL)
    .value("VK_EREOF"               , LIEF::PE::ACCELERATOR_VK_CODES::VK_EREOF)
    .value("VK_PLAY"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_PLAY)
    .value("VK_ZOOM"                , LIEF::PE::ACCELERATOR_VK_CODES::VK_ZOOM)
