  ...
  py::class_<ResourceDirectory, ResourceNode>(m, "ResourceDirectory")
      ...
      .def_property("numberof_name_entries",
                    static_cast<getter_t<uint16_t>>(
                        &ResourceDirectory::numberof_name_entries),
      ...
      .def_property("numberof_id_entries",
                    static_cast<getter_t<uint16_t>>(
                        &ResourceDirectory::numberof_id_entries),
                    static_cast<setter_t<uint16_t>>(
                        &ResourceDirectory::numberof_id_entries),
                    "The number of directory entries immediately "
      ...
      .def("__hash__",
           [](const ResourceDirectory& node) { return Hash::hash(node); })

      .def("__str__", [](const ResourceDirectory& directory) {
