  ...
  py::class_<Builder>(m, "Builder",
      ...
      .def(
          ...
          [](Builder& self) -> py::object {
            return error_or(
                static_cast<ok_error_t (Builder::*)()>(&Builder::build), self);
          },
          "Perform the build process")

      .def("build_imports", &Builder::build_imports,
           "Rebuild the import table into another section",
           py::arg("enable") = true, py::return_value_policy::reference)

      .def("patch_imports", &Builder::patch_imports,
      ...
      .def("__str__", [](const Builder& builder) {
