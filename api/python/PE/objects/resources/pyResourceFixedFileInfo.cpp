  ...
  py::class_<ResourceFixedFileInfo, LIEF::Object>(m, "ResourceFixedFileInfo",
      ...
      .def_property("struct_version",
                    static_cast<getter_t<uint32_t>>(
                        &ResourceFixedFileInfo::struct_version),
      ...
      .def_property("file_version_MS",
                    static_cast<getter_t<uint32_t>>(
                        &ResourceFixedFileInfo::file_version_MS),
                    static_cast<setter_t<uint32_t>>(
                        &ResourceFixedFileInfo::file_version_MS),
                    R"delim(
      ...
      .def_property("file_version_LS",
                    static_cast<getter_t<uint32_t>>(
                        &ResourceFixedFileInfo::file_version_LS),
                    static_cast<setter_t<uint32_t>>(
                        &ResourceFixedFileInfo::file_version_LS),
                    R"delim(
      ...
      .def_property("product_version_MS",
                    static_cast<getter_t<uint32_t>>(
                        &ResourceFixedFileInfo::product_version_MS),
                    static_cast<setter_t<uint32_t>>(
                        &ResourceFixedFileInfo::product_version_MS),
                    R"delim(
      ...
      .def_property("product_version_LS",
                    static_cast<getter_t<uint32_t>>(
                        &ResourceFixedFileInfo::product_version_LS),
                    static_cast<setter_t<uint32_t>>(
                        &ResourceFixedFileInfo::product_version_LS),
                    R"delim(
      ...
      .def_property("file_flags_mask",
                    static_cast<getter_t<uint32_t>>(
                        &ResourceFixedFileInfo::file_flags_mask),
                    static_cast<setter_t<uint32_t>>(
                        &ResourceFixedFileInfo::file_flags_mask),
                    R"delim(
      ...
      .def_property(
          ...
          "file (" RST_CLASS_REF(lief.PE.FIXED_VERSION_FILE_FLAGS) ")")

      .def_property("file_os",
                    static_cast<getter_t<FIXED_VERSION_OS>>(
                        &ResourceFixedFileInfo::file_os),
                    static_cast<setter_t<FIXED_VERSION_OS>>(
                        &ResourceFixedFileInfo::file_os),
                    "The operating system for which this file was designed "
                    "(" RST_CLASS_REF(lief.PE.FIXED_VERSION_OS) ")")

      .def_property("file_type",
                    static_cast<getter_t<FIXED_VERSION_FILE_TYPES>>(
                        &ResourceFixedFileInfo::file_type),
                    static_cast<setter_t<FIXED_VERSION_FILE_TYPES>>(
                        &ResourceFixedFileInfo::file_type),
                    "The general type of file (" RST_CLASS_REF(
                        lief.PE.FIXED_VERSION_FILE_TYPES) ")")

      .def_property("file_subtype",
                    static_cast<getter_t<FIXED_VERSION_FILE_SUB_TYPES>>(
                        &ResourceFixedFileInfo::file_subtype),
                    static_cast<setter_t<FIXED_VERSION_FILE_SUB_TYPES>>(
                        &ResourceFixedFileInfo::file_subtype),
                    "The function of the file (" RST_CLASS_REF(
      ...
      .def("__str__", [](const ResourceFixedFileInfo& fixed_file_info) {
