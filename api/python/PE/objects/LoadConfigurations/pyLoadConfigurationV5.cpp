  ...
  py::class_<LoadConfigurationV5, LoadConfigurationV4>(m, "LoadConfigurationV5",
      ...
      .def_property("guard_rf_failure_routine",
                    static_cast<getter_t<uint64_t>>(
                        &LoadConfigurationV5::guard_rf_failure_routine),
      ...
      .def_property(
          ...
          static_cast<getter_t<uint64_t>>(
              &LoadConfigurationV5::guard_rf_failure_routine_function_pointer),
          static_cast<setter_t<uint64_t>>(
              &LoadConfigurationV5::guard_rf_failure_routine_function_pointer),
      ...
      .def_property(
          ...
          static_cast<getter_t<uint32_t>>(
              &LoadConfigurationV5::dynamic_value_reloctable_offset),
      ...
      .def_property("dynamic_value_reloctable_section",
                    static_cast<getter_t<uint16_t>>(
                        &LoadConfigurationV5::dynamic_value_reloctable_section),
      ...
      .def("__hash__",
           [](const LoadConfigurationV5& config) { return Hash::hash(config); })
