...
void create<Debug>(py::module& m) {
  py::class_<Debug, LIEF::Object>(m, "Debug")
      ...
      .def_property("type", static_cast<getter_t<DEBUG_TYPES>>(&Debug::type),
                    static_cast<setter_t<DEBUG_TYPES>>(&Debug::type),
                    "The format (" RST_CLASS_REF(
                        lief.PE.DEBUG_TYPES) ") of the debugging information")
      ...
      .def_property_readonly("has_code_view", &Debug::has_code_view,
      ...
      .def_property_readonly("has_pogo", &Debug::has_pogo,
      ...
      .def("__hash__", [](const Debug& debug) { return Hash::hash(debug); })
