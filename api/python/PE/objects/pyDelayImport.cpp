...
void create<DelayImport>(py::module& m) {
  ...
  imp.def(py::init<const std::string&>(), "Constructor from a library name",
          "library_name"_a)

      .def_property_readonly(
          "entries",
          static_cast<no_const_getter<DelayImport::it_entries>>(
              &DelayImport::entries),
          "Iterator over the " RST_CLASS_REF(
              lief.PE.DelayImportEntry) " (functions)",
      ...
      .def_property("iat", static_cast<getter_t<uint32_t>>(&DelayImport::iat),
      ...
      .def_property("biat", static_cast<getter_t<uint32_t>>(&DelayImport::biat),
      ...
      .def_property("uiat", static_cast<getter_t<uint32_t>>(&DelayImport::uiat),
      ...
      .def("__hash__",
           [](const DelayImport& import) { return Hash::hash(import); })
