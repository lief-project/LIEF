...
void create<ExportEntry>(py::module& m) {
  ...
  py::class_<ExportEntry::forward_information_t>(export_entry,
  ...
  export_entry
      ...
      .def_property_readonly("is_forwarded", &ExportEntry::is_forwarded)

      .def_property_readonly("forward_information",
                             &ExportEntry::forward_information)

      .def_property_readonly("function_rva", &ExportEntry::function_rva)
