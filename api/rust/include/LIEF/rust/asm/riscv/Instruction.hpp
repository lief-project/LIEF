...
class asm_riscv_Instruction : public asm_Instruction {
  public:
  using lief_t = LIEF::assembly::riscv::Instruction;

  class it_operands
    : public ForwardIterator<asm_riscv_Operand,
                             LIEF::assembly::riscv::Operand::Iterator> {
    public:
    it_operands(const asm_riscv_Instruction::lief_t& src) :
...
using asm_riscv_Instruction_it_operands = asm_riscv_Instruction::it_operands;
