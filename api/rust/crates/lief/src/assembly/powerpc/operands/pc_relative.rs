...
pub struct PCRelative {
    ptr: cxx::UniquePtr<ffi::asm_powerpc_operands_PCRelative>,
}

impl FromFFI<ffi::asm_powerpc_operands_PCRelative> for PCRelative {
    fn from_ffi(ptr: cxx::UniquePtr<ffi::asm_powerpc_operands_PCRelative>) -> Self {
        Self { ptr }
    }
}
