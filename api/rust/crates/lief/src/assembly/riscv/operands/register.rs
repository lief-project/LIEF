...
use crate::assembly::riscv::registers::{Reg, SysReg};
...
/// ```
pub struct Register {
    ptr: cxx::UniquePtr<ffi::asm_riscv_operands_Register>,
}

impl FromFFI<ffi::asm_riscv_operands_Register> for Register {
    fn from_ffi(ptr: cxx::UniquePtr<ffi::asm_riscv_operands_Register>) -> Self {
        Self { ptr }
    }
}
