...
include_cpp! {
    ...
    generate!("ELF_Binary_it_symbols")
    block_constructors!("ELF_Binary_it_symbols")
    ...
    generate!("ELF_DynamicEntryAuxiliary")
    block_constructors!("ELF_DynamicEntryAuxiliary")
    generate!("ELF_DynamicEntryFilter")
    block_constructors!("ELF_DynamicEntryFilter")
    ...
    generate!("ELF_AndroidIdent")
    block_constructors!("ELF_AndroidIdent")
    generate!("ELF_NoteAbi")
    block_constructors!("ELF_NoteAbi")
    generate!("ELF_NoteGnuProperty")
    block_constructors!("ELF_NoteGnuProperty")
    generate!("ELF_NoteGnuProperty_it_properties")
    block_constructors!("ELF_NoteGnuProperty_it_properties")
    generate!("ELF_NoteGnuProperty_Property")
    block_constructors!("ELF_NoteGnuProperty_Property")
    generate!("ELF_NoteGnuProperty_AArch64Feature")
    block_constructors!("ELF_NoteGnuProperty_AArch64Feature")
    generate!("ELF_NoteGnuProperty_AArch64PAuth")
    block_constructors!("ELF_NoteGnuProperty_AArch64PAuth")
    generate!("ELF_NoteGnuProperty_Generic")
    block_constructors!("ELF_NoteGnuProperty_Generic")
    generate!("ELF_NoteGnuProperty_Needed")
    block_constructors!("ELF_NoteGnuProperty_Needed")
    generate!("ELF_NoteGnuProperty_NoteNoCopyOnProtected")
    block_constructors!("ELF_NoteGnuProperty_NoteNoCopyOnProtected")
    generate!("ELF_NoteGnuProperty_StackSize")
    block_constructors!("ELF_NoteGnuProperty_StackSize")
    generate!("ELF_NoteGnuProperty_X86Features")
    block_constructors!("ELF_NoteGnuProperty_X86Features")
    generate!("ELF_NoteGnuProperty_X86ISA")
    block_constructors!("ELF_NoteGnuProperty_X86ISA")
    generate!("ELF_QNXStack")
    block_constructors!("ELF_QNXStack")
    generate!("ELF_CoreAuxv")
    block_constructors!("ELF_CoreAuxv")
    generate!("ELF_CoreFile")
    block_constructors!("ELF_CoreFile")
    generate!("ELF_CoreFile_entry")
    block_constructors!("ELF_CoreFile_entry")
    generate!("ELF_CoreFile_it_files")
    block_constructors!("ELF_CoreFile_it_files")
    generate!("ELF_CorePrPsInfo")
    block_constructors!("ELF_CorePrPsInfo")
    generate!("ELF_CorePrStatus")
    block_constructors!("ELF_CorePrStatus")
    generate_pod!("ELF_CorePrStatus_Status")
    block_constructors!("ELF_CorePrStatus_Status")
    generate!("ELF_CoreSigInfo")
    block_constructors!("ELF_CoreSigInfo")
    ...
    generate!("PE_ResourcesManager_string_entry_t")
    block_constructors!("PE_ResourcesManager_string_entry_t")
    generate!("PE_ResourcesManager_it_icons")
    block_constructors!("PE_ResourcesManager_it_icons")
    generate!("PE_ResourcesManager_it_version")
    block_constructors!("PE_ResourcesManager_it_version")
    generate!("PE_ResourcesManager_it_accelerator")
    block_constructors!("PE_ResourcesManager_it_accelerator")
    generate!("PE_ResourcesManager_it_string_table_entry")
    block_constructors!("PE_ResourcesManager_it_string_table_entry")
    generate!("PE_ResourceIcon")
    block_constructors!("PE_ResourceIcon")
    generate!("PE_ResourceVersion")
    block_constructors!("PE_ResourceVersion")
    generate!("PE_ResourceStringFileInfo")
    block_constructors!("PE_ResourceStringFileInfo")
    generate!("PE_ResourceStringFileInfo_it_children")
    block_constructors!("PE_ResourceStringFileInfo_it_children")
    generate!("PE_ResourceVarFileInfo")
    block_constructors!("PE_ResourceVarFileInfo")
    generate!("PE_ResourceVarFileInfo_it_vars")
    block_constructors!("PE_ResourceVarFileInfo_it_vars")
    generate!("PE_ResourceStringTable")
    block_constructors!("PE_ResourceStringTable")
    generate!("PE_ResourceStringTable_it_entries")
    block_constructors!("PE_ResourceStringTable_it_entries")
    generate!("PE_ResourceStringTable_entry_t")
    block_constructors!("PE_ResourceStringTable_entry_t")
    generate!("PE_ResourceVar")
    block_constructors!("PE_ResourceVar")
    generate!("PE_ResourceAccelerator")
    block_constructors!("PE_ResourceAccelerator")
    ...
    generate!("MachO_Binary_it_rpaths")
    block_constructors!("MachO_Binary_it_rpaths")
    ...
    generate!("MachO_BuildVersion_it_tools")
    block_constructors!("MachO_BuildVersion_it_tools")
    ...
    generate!("MachO_ThreadLocalVariables")
    block_constructors!("MachO_ThreadLocalVariables")
    generate!("MachO_ThreadLocalVariables_Thunk")
    block_constructors!("MachO_ThreadLocalVariables_Thunk")
    generate!("MachO_ThreadLocalVariables_it_thunks")
    block_constructors!("MachO_ThreadLocalVariables_it_thunks")
    ...
    generate!("PDB_types_Enum_Entry")
    block_constructors!("PDB_types_Enum_Entry")
    generate!("PDB_types_Enum_it_entries")
    block_constructors!("PDB_types_Enum_it_entries")
