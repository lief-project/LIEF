...
enum LIEF_ARCH {
  ...
  LIEF_EM_ARC_COMPACT = 93, /**< ARC International ARCompact processor (old
  ...
  LIEF_EM_UNICORE = 110, /**< Microprocessor series from PKU-Unity Ltd. and MPRC of
                            Peking University */
...
enum LIEF_MIPS_EFLAGS {
  ...
  LIEF_EF_MIPS_ABI_O64 =
      0x00002000, /* O32 ABI extended for 64-bit architecture. */
  ...
  LIEF_EF_MIPS_ARCH_32 =
      0x50000000, /* MIPS32 instruction set per linux not elf.h */
  LIEF_EF_MIPS_ARCH_64 =
      0x60000000, /* MIPS64 instruction set per linux not elf.h */
...
enum LIEF_ELF_SECTION_TYPES {
  ...
  LIEF_SHT_LLVM_ADDRSIG = 0x6fff4c03, /**< This section is used to mark symbols as
                                         address-significant. */
  ...
  LIEF_SHT_ARM_PREEMPTMAP =
      0x70000002U, /**< BPABI DLL dynamic linking pre-emption map */
  LIEF_SHT_ARM_ATTRIBUTES =
      0x70000003U, /**<  Object file compatibility attributes */
...
enum LIEF_ELF_SECTION_FLAGS {
  ...
  LIEF_SHF_EXECINSTR =
      0x4,               /**< Section contains executable machine instructions. */
  LIEF_SHF_MERGE = 0x10, /**< The data in this section may be merged. */
  LIEF_SHF_STRINGS =
      0x20, /**< The data in this section is null-terminated strings. */
  LIEF_SHF_INFO_LINK =
      0x40U, /**< A field in this section holds a section header table index. */
  LIEF_SHF_LINK_ORDER =
      0x80U, /**< Adds special ordering requirements for link editors. */
  LIEF_SHF_OS_NONCONFORMING =
      0x100U, /**< This section requires special OS-specific processing to avoid
                 incorrect behavior */
  ...
  LIEF_SHF_EXCLUDE = 0x80000000U, /**< This section is excluded from the final
  ...
  LIEF_SHF_MIPS_NAMES =
      0x02000000, /**< Linker must generate implicit hidden weak names. */
  LIEF_SHF_MIPS_LOCAL = 0x04000000,   /**< Section data local to process. */
  LIEF_SHF_MIPS_NOSTRIP = 0x08000000, /**< Do not strip this section. */
  LIEF_SHF_MIPS_GPREL =
      0x10000000, /**< Section must be part of global data area. */
  LIEF_SHF_MIPS_MERGE = 0x20000000, /**< This section should be merged. */
  LIEF_SHF_MIPS_ADDR =
      0x40000000, /**< Address size to be inferred from section entry size. */
  LIEF_SHF_MIPS_STRING =
      0x80000000, /**< Section data is string data by default. */
};
...
enum LIEF_SYMBOL_BINDINGS {
  ...
  LIEF_STB_GLOBAL =
      1, /**< Global symbol, visible to all object files being combined */
...
enum LIEF_SEGMENT_TYPES {
  ...
  LIEF_PT_HIOS =
      0x6fffffff, /**< Highest operating system-specific pt entry type. */
  LIEF_PT_LOPROC =
      0x70000000, /**< Lowest processor-specific program hdr entry type. */
  LIEF_PT_HIPROC =
      0x7fffffff, /**< Highest processor-specific program hdr entry type. */
  ...
  LIEF_PT_ARM_ARCHEXT =
      0x70000000, /**< Platform architecture compatibility info */
...
enum LIEF_ELF_SEGMENT_FLAGS {
  ...
  LIEF_PF_R = 4, /**< Read */
  LIEF_PF_MASKOS =
      0x0ff00000, /**< Bits for operating system-specific semantics. */
...
enum LIEF_DYNAMIC_TAGS {
  ...
  LIEF_DT_ENCODING = 32, /**< Values from here to DT_LOOS follow the rules for the
  ...
  LIEF_DT_TLSDESC_GOT = 0x6FFFFEF7, /**< Location of GOT entry for TLS descriptor
                                       resolver PLT entry. */
  ...
  LIEF_DT_VERNEED =
      0x6FFFFFFE, /**< The address of the version Dependency table. */
  ...
  LIEF_DT_MIPS_IVERSION =
      0x70000004,                  /**< Index of version string in string table. */
  ...
  LIEF_DT_MIPS_CONFLICTNO =
      0x7000000b, /**< Number of entries in the .conflict section. */
  LIEF_DT_MIPS_LIBLISTNO =
      0x70000010, /**< Number of entries in the .liblist section. */
  LIEF_DT_MIPS_SYMTABNO =
      0x70000011, /**< Number of entries in the .dynsym section. */
  LIEF_DT_MIPS_UNREFEXTNO = 0x70000012, /**< Index of first external dynamic symbol
  ...
  LIEF_DT_MIPS_DELTA_CLASS_NO =
      0x70000018, /**< Number of entries in DT_MIPS_DELTA_CLASS. */
  ...
  LIEF_DT_MIPS_DELTA_RELOC_NO =
      0x7000001C, /**< Number of entries in DT_MIPS_DELTA_RELOC. */
  LIEF_DT_MIPS_DELTA_SYM =
      0x7000001D, /**< Delta symbols that Delta relocations refer to. */
  LIEF_DT_MIPS_DELTA_SYM_NO =
      0x7000001E, /**< Number of entries in DT_MIPS_DELTA_SYM. */
  LIEF_DT_MIPS_DELTA_CLASSSYM =
      0x70000020, /**< Delta symbols that hold class declarations. */
  ...
  LIEF_DT_MIPS_PERF_SUFFIX = 0x7000002E, /**< Default suffix of DSO to be added by
                                            rld on dlopen( calls. */
  LIEF_DT_MIPS_COMPACT_SIZE =
      0x7000002F, /**< Size of compact relocation section (O32. */
  ...
  LIEF_DT_ANDROID_REL_OFFSET =
      0x6000000D, /**< The offset of packed relocation data (older version < M)
                     (Android specific. */
  LIEF_DT_ANDROID_REL_SIZE =
      0x6000000E, /**< The size of packed relocation data in bytes (older version <
                     M) (Android specific. */
  LIEF_DT_ANDROID_REL =
      0x6000000F, /**< The offset of packed relocation data (Android specific. */
  LIEF_DT_ANDROID_RELSZ = 0x60000010, /**< The size of packed relocation data in
                                         bytes (Android specific. */
  LIEF_DT_ANDROID_RELA =
      0x60000011, /**< The offset of packed relocation data (Android specific. */
  LIEF_DT_ANDROID_RELASZ = 0x60000012, /**< The size of packed relocation data in
                                          bytes (Android specific. */
  LIEF_DT_ANDROID_RELR =
      0x6FFFE000, /**< The offset of new relr relocation data (Android specific. */
  LIEF_DT_ANDROID_RELRSZ = 0x6FFFE001, /**< The size of nre relr relocation data in
                                          bytes (Android specific. */
  LIEF_DT_ANDROID_RELRENT = 0x6FFFE003, /**< The size of a new relr relocation
                                           entry (Android specific. */
  LIEF_DT_ANDROID_RELRCOUNT =
      0x6FFFE005, /**< Specifies the relative count of new relr relocation entries
                     (Android specific. */
...
enum LIEF_DYNAMIC_FLAGS {
  ...
  LIEF_DF_SYMBOLIC =
      0x00000002, /**< Search the shared lib before searching the exe. */
  LIEF_DF_TEXTREL =
      0x00000004, /**< Relocations may modify a non-writable segment. */
...
enum LIEF_DYNSYM_COUNT_METHODS {
  ...
  LIEF_COUNT_RELOCATIONS =
      3, /**< Count based on PLT/GOT relocations (very reliable but not accurate */
};
