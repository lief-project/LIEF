...
LIEF_API const char* ELF_SECTION_TYPES_to_string(
    enum LIEF_ELF_ELF_SECTION_TYPES e);
LIEF_API const char* ELF_SECTION_FLAGS_to_string(
    enum LIEF_ELF_ELF_SECTION_FLAGS e);
LIEF_API const char* ELF_SYMBOL_TYPES_to_string(
    enum LIEF_ELF_ELF_SYMBOL_TYPES e);
