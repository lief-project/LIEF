...
enum LIEF_PE_HEADER_CHARACTERISTICS {
  ...
  LIEF_PE_HEADER_CHARACTERISTICS_RELOCS_STRIPPED =
      0x0001, /**< The file does not contain base relocations and must be loaded at
                 its preferred base. If this cannot be done, the loader will
                 error.*/
  LIEF_PE_HEADER_CHARACTERISTICS_EXECUTABLE_IMAGE =
      0x0002, /**< The file is valid and can be run.*/
  ...
  LIEF_PE_HEADER_CHARACTERISTICS_AGGRESSIVE_WS_TRIM =
      0x0010, /**< Aggressively trim working set. This is deprecated and must be
                 0.*/
  ...
  LIEF_PE_HEADER_CHARACTERISTICS_DEBUG_STRIPPED =
      0x0200, /**< Debugging info has been removed. */
  LIEF_PE_HEADER_CHARACTERISTICS_REMOVABLE_RUN_FROM_SWAP =
      0x0400, /**< If the image is on removable media, fully load it and copy it to
                 swap. */
  LIEF_PE_HEADER_CHARACTERISTICS_NET_RUN_FROM_SWAP =
      0x0800, /**< If the image is on network media, fully load it and copy it to
                 swap. */
  ...
  LIEF_PE_HEADER_CHARACTERISTICS_BYTES_REVERSED_HI =
      0x8000, /**< Big endian: the MSB precedes the LSB in memory. This is
                 deprecated */
};
...
LIEF_API const char*
    lief_pe_header_characteristics_str(enum LIEF_PE_HEADER_CHARACTERISTICS e);
