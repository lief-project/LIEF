...
LIEF_API const char* LOAD_COMMAND_TYPES_to_string(
    enum LIEF_MACHO_LOAD_COMMAND_TYPES e);
...
LIEF_API const char* MACHO_SECTION_TYPES_to_string(
    enum LIEF_MACHO_MACHO_SECTION_TYPES e);
LIEF_API const char* MACHO_SYMBOL_TYPES_to_string(
    enum LIEF_MACHO_MACHO_SYMBOL_TYPES e);
LIEF_API const char* N_LIST_TYPES_to_string(enum LIEF_MACHO_N_LIST_TYPES e);
LIEF_API const char* SYMBOL_DESCRIPTIONS_to_string(
