...
const char* LOAD_COMMAND_TYPES_to_string(enum LIEF_MACHO_LOAD_COMMAND_TYPES e) {
  return LIEF::MachO::to_string(
      static_cast<LIEF::MachO::LOAD_COMMAND_TYPES>(e));
}
...
const char* MACHO_SECTION_TYPES_to_string(
    enum LIEF_MACHO_MACHO_SECTION_TYPES e) {
  return LIEF::MachO::to_string(
      static_cast<LIEF::MachO::MACHO_SECTION_TYPES>(e));
}

const char* MACHO_SYMBOL_TYPES_to_string(enum LIEF_MACHO_MACHO_SYMBOL_TYPES e) {
  return LIEF::MachO::to_string(
      static_cast<LIEF::MachO::MACHO_SYMBOL_TYPES>(e));
}
...
const char* SYMBOL_DESCRIPTIONS_to_string(
    enum LIEF_MACHO_SYMBOL_DESCRIPTIONS e) {
  return LIEF::MachO::to_string(
      static_cast<LIEF::MachO::SYMBOL_DESCRIPTIONS>(e));
}
}
