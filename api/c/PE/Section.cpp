...
void init_c_sections(Pe_Binary_t* c_binary, Binary* binary) {
  ...
  for (size_t i = 0; i < sections.size(); ++i) {
    ...
    c_binary->sections[i]->pointerto_relocation =
        b_section.pointerto_relocation();
    c_binary->sections[i]->pointerto_line_numbers =
        b_section.pointerto_line_numbers();
