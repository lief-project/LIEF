...
void init_c_optional_header(Pe_Binary_t* c_binary, Binary* binary) {
  ...
  c_binary->optional_header.magic =
      static_cast<enum LIEF_PE_PE_TYPES>(optional_header.magic());
  c_binary->optional_header.major_linker_version =
      optional_header.major_linker_version();
  c_binary->optional_header.minor_linker_version =
      optional_header.minor_linker_version();
  c_binary->optional_header.sizeof_code = optional_header.sizeof_code();
  c_binary->optional_header.sizeof_initialized_data =
      optional_header.sizeof_initialized_data();
  c_binary->optional_header.sizeof_uninitialized_data =
      optional_header.sizeof_uninitialized_data();
  c_binary->optional_header.addressof_entrypoint =
  ...
  c_binary->optional_header.major_image_version =
      optional_header.major_image_version();
  c_binary->optional_header.minor_image_version =
      optional_header.minor_image_version();
  c_binary->optional_header.major_subsystem_version =
      optional_header.major_subsystem_version();
  c_binary->optional_header.minor_subsystem_version =
      optional_header.minor_subsystem_version();
  c_binary->optional_header.win32_version_value =
  ...
  c_binary->optional_header.subsystem =
      static_cast<enum LIEF_PE_SUBSYSTEM>(optional_header.subsystem());
  c_binary->optional_header.dll_characteristics =
      optional_header.dll_characteristics();
  c_binary->optional_header.sizeof_stack_reserve =
      optional_header.sizeof_stack_reserve();
  c_binary->optional_header.sizeof_stack_commit =
      optional_header.sizeof_stack_commit();
  c_binary->optional_header.sizeof_heap_reserve =
      optional_header.sizeof_heap_reserve();
  c_binary->optional_header.sizeof_heap_commit =
      optional_header.sizeof_heap_commit();
  c_binary->optional_header.loader_flags = optional_header.loader_flags();
  c_binary->optional_header.numberof_rva_and_size =
