...
void init_c_dos_header(Pe_Binary_t* c_binary, Binary* binary) {
  ...
  c_binary->dos_header.used_bytes_in_the_last_page =
  ...
  c_binary->dos_header.header_size_in_paragraphs =
      dos_header.header_size_in_paragraphs();
  c_binary->dos_header.minimum_extra_paragraphs =
      dos_header.minimum_extra_paragraphs();
  c_binary->dos_header.maximum_extra_paragraphs =
  ...
  c_binary->dos_header.addressof_relocation_table =
  ...
  c_binary->dos_header.addressof_new_exeheader =
