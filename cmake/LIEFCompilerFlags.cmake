...
if(MSVC)
  target_compile_definitions(LIB_LIEF PRIVATE NOMINMAX)
  ...
  target_compile_options(LIB_LIEF PRIVATE
    ...
    /wd4319 # Suppress ''operator' : zero extending 'type' to 'type' of greater size'
            ...
            # v15.8.8. Re-evaluate the usefulness of this diagnostic when the bug is fixed.
...
if (MSVC_IDE)
  ...
  if (NOT LIEF_COMPILER_JOBS STREQUAL "1")
    if(LIEF_COMPILER_JOBS STREQUAL "0")
      ...
      target_compile_options(LIB_LIEF PRIVATE /MP)
    else()
      message(STATUS "Number of parallel compiler jobs set to /MP${LIEF_COMPILER_JOBS}")
      target_compile_options(LIB_LIEF PRIVATE /MP${LIEF_COMPILER_JOBS})
    endif()
  else()
