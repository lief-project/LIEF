...
# variant
# ------
set(LIBVARIANT_VERSION 1.2.0)
set(LIBVARIANT_SHA256 SHA256=48df02096b954ea35c447edc3e662e7f163a92e1de2ab5f226445d6001a4537d)
set(LIBVARIANT_URL     "${THIRD_PARTY_DIRECTORY}/variant-${LIBVARIANT_VERSION}.zip")
ExternalProject_Add(lief_variant
  URL               ${LIBVARIANT_URL}
  URL_HASH          ${LIBVARIANT_SHA256}
  UPDATE_COMMAND    ""
  CONFIGURE_COMMAND ""
  BUILD_COMMAND     ""
  INSTALL_COMMAND   "")
ExternalProject_get_property(lief_variant SOURCE_DIR)
set(LIBVARIANT_SOURCE_DIR "${SOURCE_DIR}")
