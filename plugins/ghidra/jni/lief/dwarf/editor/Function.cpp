...
jobject Function::jni_set_ranges(JNIEnv* env, jobject thiz, jobject ranges) {
  ...
  list.iterate([&](jni::LocalObject<Function::Range::kClass> e) {
    native_ranges.push_back(LIEF::dwarf::editor::Function::range_t{
        (uint64_t)e.Access<"start">().Get(),
        (uint64_t)e.Access<"end">().Get(),
    });
  });
...
jobject Function::LexicalBlock::jni_add_block_from_range(JNIEnv* env, jobject thiz,
                                                         jobject ranges) {
  java::util::List<Function::Range> list = ranges;
  std::vector<LIEF::dwarf::editor::Function::range_t> native_ranges;
...
int Function::LexicalBlock::register_natives(JNIEnv* env) {
  static const std::array NATIVE_METHODS{
      ...
      make("addName",
           "(Ljava/lang/String;)Llief/dwarf/editor/Function$LexicalBlock;",
           &jni_add_name),
      make("addBlock", "(JJ)Llief/dwarf/editor/Function$LexicalBlock;",
           &jni_add_block),
      make("addBlock",
...
int Function::register_natives(JNIEnv* env) {
  static const std::array NATIVE_METHODS{
      make("setAddress", "(J)Llief/dwarf/editor/Function;", &jni_set_address),
      make("setLowHigh", "(JJ)Llief/dwarf/editor/Function;", &jni_set_low_high),
      make("setRanges", "(Ljava/util/List;)Llief/dwarf/editor/Function;",
           &jni_set_ranges),
      make("setExternal", "()Llief/dwarf/editor/Function;", &jni_set_exeternal),
      make("setReturnType",
      ...
      make("addParameter",
           ...
           "Function$Parameter;",
           &jni_add_parameter),
      make("createStackVariable",
           "(Ljava/lang/String;)Llief/dwarf/editor/Variable;",
           &jni_create_stack_variable),
      make("createStackVariable",
           "(Ljava/lang/String;)Llief/dwarf/editor/Variable;",
           &jni_create_stack_variable),
      make("addLexicalBlock", "(JJ)Llief/dwarf/editor/Function$LexicalBlock;",
           &jni_create_lexical_block),
      make("addLabel", "(JLjava/lang/String;)Llief/dwarf/editor/Function$Label;",
           &jni_add_label),
      make("addDescription", "(Ljava/lang/String;)Llief/dwarf/editor/Function;",
           &jni_add_description),
      make_destroy(&jni_destroy),
  };
