...
thread_local jni::ThreadLocalGuardDestructor
    jni::ThreadGuard::thread_local_guard_destructor{};
...
int Utils::register_natives(JNIEnv* env) {
  static const std::array NATIVE_METHODS{
      ...
      make("getExtendedVersionInfo", "()Ljava/lang/String;",
           &jni_get_extended_version_info),
      make("getExtendedVersion", "()Llief/Utils$Version;",
           &jni_get_extended_version),
      make("getVersion", "()Llief/Utils$Version;", &jni_get_version),
  };
