...
class Binary : public generic::Binary {
  ...
  class ExceptionsIterator
    : public lief_jni::Iterator<ExceptionsIterator,
                                LIEF::PE::Binary::it_exceptions,
                                lief_jni::pe::ExceptionInfo> {
    public:
    static constexpr jni::Class kClass{"lief/pe/Binary$ExceptionsIterator",
                                       jni::Constructor{jlong{}},
                                       jni::Field{
                                           "impl",
                                           jlong{},
  ...
  static jobject jni_parse(JNIEnv* env, jobject thiz, jstring path) {
    ...
    return Binary::create<Binary>(LIEF::PE::Parser::parse(
        std::string(jpath.Pin().ToString()), LIEF::PE::ParserConfig::all()
    ));
  }
