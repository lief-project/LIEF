...
#define GHIDRA_TRACE(...)                                                         \
  LIEF::logging::named::debug(GHIDRA_LIEF_LOGGER_NAME,                            \
                              ::LIEF::ghidra::fmt_str(__VA_ARGS__))
#define GHIDRA_DEBUG(...)                                                         \
  LIEF::logging::named::debug(GHIDRA_LIEF_LOGGER_NAME,                            \
                              ::LIEF::ghidra::fmt_str(__VA_ARGS__))
#define GHIDRA_INFO(...)                                                          \
  LIEF::logging::named::info(GHIDRA_LIEF_LOGGER_NAME,                             \
                             ::LIEF::ghidra::fmt_str(__VA_ARGS__))
#define GHIDRA_WARN(...)                                                          \
  LIEF::logging::named::warn(GHIDRA_LIEF_LOGGER_NAME,                             \
                             ::LIEF::ghidra::fmt_str(__VA_ARGS__))
#define GHIDRA_ERR(...)                                                           \
  LIEF::logging::named::err(GHIDRA_LIEF_LOGGER_NAME,                              \
                            ::LIEF::ghidra::fmt_str(__VA_ARGS__))
...
[[noreturn]] void fatal_error(const char* fmt, const Args&... args) {
  LIEF::logging::named::critical(
      GHIDRA_LIEF_LOGGER_NAME, LIEF::ghidra::fmt_str(fmt::runtime(fmt), args...)
  );
  terminate();
}
