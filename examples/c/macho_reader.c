...
void print_binary(Macho_Binary_t* binary) {
  ...
  for (i = 0; commands[i] != NULL; ++i) {
    ...
    fprintf(stdout,
            ...
            "0x%06" PRIx32 " "
            "\n",
            command->command, command->size, command->offset);
    if (command->size > 3) {
  ...
  for (i = 0; segments[i] != NULL; ++i) {
    ...
    fprintf(stdout,
            ...
            segment->init_protection, segment->numberof_sections, segment->flags);
  ...
  for (i = 0; sections[i] != NULL; ++i) {
    ...
    fprintf(stdout,
            ...
            section->numberof_relocations, section->flags, section->type,
